export enum AbilityId {
  ...
  POISON_PUPPETEER,
  /** Custom ability (ZARouge — Mega Solar) */
  MEGA_SOL,
  /** Custom ability (ZARouge — Dragonize) */
  DRAGONIZE,
  /** Custom ability (ZARouge — Piercing Drill) */
  PIERCING_DRILL,
  /** Custom ability (ZARouge — Spicy Spray) */
  SPICY_SPRAY,
  /** Custom ability — Mega Eelektross (Levitate + Beast Boost) */
  EELEVATE,
  /** Custom ability — Mega Pyroar (Fire-type move power boost) */
  FIRE_MANE,
}
