...
/**
 * Editor-added custom species use explicit {@linkcode SpeciesId} values in this band but are
 * appended to `allSpecies` at the end of the array (not at index `speciesId - 1`).
 */
export const CUSTOM_SPECIES_ID_MIN = 1083;
export const CUSTOM_SPECIES_ID_MAX = 1999;
