...
import { pickClassicFinalBossPhase2FormIndex } from "#balance/classic-final-boss-species";
      ...
      if (!this.loaded) {
        if (battle.battleType === BattleType.TRAINER) {
          ...
          if (globalScene.currentBattle.battleSpec === BattleSpec.FINAL_BOSS) {
            ...
            battle.finalBossPhase2FormIndex = pickClassicFinalBossPhase2FormIndex(enemySpecies);
          }
          globalScene
            .getPlayerParty()
