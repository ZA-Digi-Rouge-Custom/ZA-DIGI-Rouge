...
const pokemonPool: BiomePokemonPools = {
  [BiomePoolTier.COMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.RATTATA, SpeciesId.ZIGZAGOON, SpeciesId.PATRAT, SpeciesId.LILLIPUP, SpeciesId.BOTAMON],
...
export const metropolisBiome: Biome = {
  biomeId: BiomeId.METROPOLIS,
  pokemonPool,
  trainerPool,
  trainerChance: 4,
  weatherPool,
