...
const pokemonPool: BiomePokemonPools = {
  [BiomePoolTier.COMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.ZIGZAGOON, SpeciesId.BIDOOF, SpeciesId.LECHONK, SpeciesId.BOTAMON],
  ...
  [BiomePoolTier.UNCOMMON]: {
    ...
    [TimeOfDay.DAWN]: [SpeciesId.DODUO, SpeciesId.POOCHYENA, SpeciesId.STARLY, SpeciesId.PIDOVE, SpeciesId.ROCKRUFF, SpeciesId.PAWMI],
    [TimeOfDay.DAY]: [SpeciesId.DODUO, SpeciesId.POOCHYENA, SpeciesId.STARLY, SpeciesId.PIDOVE, SpeciesId.ROCKRUFF, SpeciesId.PAWMI],
...
export const plainsBiome: Biome = {
