...
const pokemonPool: BiomePokemonPools = {
  [BiomePoolTier.COMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.ORICORIO, SpeciesId.ALOLA_SANDSHREW, SpeciesId.ALOLA_VULPIX, SpeciesId.ALOLA_DIGLETT, SpeciesId.ALOLA_GEODUDE, SpeciesId.ALOLA_GRIMER, SpeciesId.BOTAMON],
    [TimeOfDay.DAWN]: [],
    [TimeOfDay.DAY]: [],
...
export const islandBiome: Biome = {
  biomeId: BiomeId.ISLAND,
  pokemonPool,
  trainerPool,
  trainerChance: 12,
  weatherPool,
