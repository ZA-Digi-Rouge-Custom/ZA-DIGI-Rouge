...
const pokemonPool: BiomePokemonPools = {
  [BiomePoolTier.COMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.GASTLY, SpeciesId.SHUPPET, SpeciesId.DUSKULL, SpeciesId.DRIFLOON, SpeciesId.LITWICK, SpeciesId.PHANTUMP, SpeciesId.PUMPKABOO, SpeciesId.GREAVARD, SpeciesId.BOTAMON],
    [TimeOfDay.DAWN]: [],
    [TimeOfDay.DAY]: [],
    [TimeOfDay.DUSK]: [],
    [TimeOfDay.NIGHT]: [],
...
export const graveyardBiome: Biome = {
  biomeId: BiomeId.GRAVEYARD,
  pokemonPool,
  trainerPool,
  trainerChance: 12,
  weatherPool,
