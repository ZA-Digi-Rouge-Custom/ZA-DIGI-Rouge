...
const pokemonPool: BiomePokemonPools = {
  [BiomePoolTier.COMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.PIDGEY, SpeciesId.RATTATA, SpeciesId.SPEAROW, SpeciesId.ZIGZAGOON, SpeciesId.WURMPLE, SpeciesId.TAILLOW, SpeciesId.BIDOOF, SpeciesId.PATRAT, SpeciesId.LILLIPUP, SpeciesId.FLETCHLING, SpeciesId.WOOLOO, SpeciesId.LECHONK, SpeciesId.BOTAMON],
    [TimeOfDay.DAWN]: [SpeciesId.CATERPIE, SpeciesId.SENTRET, SpeciesId.LEDYBA, SpeciesId.HOPPIP, SpeciesId.SUNKERN, SpeciesId.SILCOON, SpeciesId.STARLY, SpeciesId.PIDOVE, SpeciesId.COTTONEE, SpeciesId.SCATTERBUG, SpeciesId.YUNGOOS, SpeciesId.SKWOVET],
    [TimeOfDay.DAY]: [SpeciesId.CATERPIE, SpeciesId.SENTRET, SpeciesId.LEDYBA, SpeciesId.HOPPIP, SpeciesId.SUNKERN, SpeciesId.SILCOON, SpeciesId.STARLY, SpeciesId.PIDOVE, SpeciesId.COTTONEE, SpeciesId.SCATTERBUG, SpeciesId.YUNGOOS, SpeciesId.SKWOVET],
  ...
  [BiomePoolTier.RARE]: {
    [TimeOfDay.ALL]: [SpeciesId.ABRA, SpeciesId.CLEFFA, SpeciesId.IGGLYBUFF, SpeciesId.SURSKIT, SpeciesId.HAPPINY, SpeciesId.ROOKIDEE, SpeciesId.TANDEMAUS],
    [TimeOfDay.DAWN]: [],
    [TimeOfDay.DAY]: [],
    [TimeOfDay.DUSK]: [],
    [TimeOfDay.NIGHT]: [],
  ...
  [BiomePoolTier.SUPER_RARE]: {
    [TimeOfDay.ALL]: [SpeciesId.EEVEE, SpeciesId.PICHU, SpeciesId.TOGEPI, SpeciesId.RALTS, SpeciesId.NINCADA, SpeciesId.RIOLU],
    [TimeOfDay.DAWN]: [],
    [TimeOfDay.DAY]: [],
    [TimeOfDay.DUSK]: [],
    [TimeOfDay.NIGHT]: [],
...
export const townBiome: Biome = {
  biomeId: BiomeId.TOWN,
  pokemonPool,
  trainerPool,
  trainerChance: 0,
  weatherPool,
