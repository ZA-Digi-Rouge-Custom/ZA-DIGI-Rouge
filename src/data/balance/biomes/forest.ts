...
const pokemonPool: BiomePokemonPools = {
  [BiomePoolTier.COMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.TAROUNTULA, SpeciesId.NYMBLE, SpeciesId.SHROODLE, SpeciesId.BOTAMON],
    [TimeOfDay.DAWN]: [SpeciesId.BUTTERFREE, SpeciesId.BELLSPROUT, SpeciesId.COMBEE, SpeciesId.PETILIL, SpeciesId.DEERLING, SpeciesId.VIVILLON],
    [TimeOfDay.DAY]: [SpeciesId.BUTTERFREE, SpeciesId.BELLSPROUT, SpeciesId.BEAUTIFLY, SpeciesId.COMBEE, SpeciesId.PETILIL, SpeciesId.DEERLING, SpeciesId.VIVILLON],
    [TimeOfDay.DUSK]: [SpeciesId.BEEDRILL, SpeciesId.SPINARAK, SpeciesId.PINECO, SpeciesId.SEEDOT, SpeciesId.SHROOMISH, SpeciesId.VENIPEDE],
    [TimeOfDay.NIGHT]: [SpeciesId.BEEDRILL, SpeciesId.VENONAT, SpeciesId.SPINARAK, SpeciesId.PINECO, SpeciesId.DUSTOX, SpeciesId.SEEDOT, SpeciesId.SHROOMISH, SpeciesId.VENIPEDE],
  },
  ...
  [BiomePoolTier.RARE]: {
    [TimeOfDay.ALL]: [SpeciesId.HERACROSS, SpeciesId.TREECKO, SpeciesId.TROPIUS, SpeciesId.KARRABLAST, SpeciesId.SHELMET, SpeciesId.CHESPIN, SpeciesId.ROWLET, SpeciesId.SQUAWKABILLY, SpeciesId.TOEDSCOOL],
