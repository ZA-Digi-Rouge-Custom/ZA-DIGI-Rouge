...
const pokemonPool: BiomePokemonPools = {
  [BiomePoolTier.COMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.SEEL, SpeciesId.SWINUB, SpeciesId.SNORUNT, SpeciesId.VANILLITE, SpeciesId.CUBCHOO, SpeciesId.BERGMITE, SpeciesId.CRABRAWLER, SpeciesId.SNOM, SpeciesId.BOTAMON],
    [TimeOfDay.DAWN]: [],
    [TimeOfDay.DAY]: [],
    [TimeOfDay.DUSK]: [],
    [TimeOfDay.NIGHT]: [],
  ...
  [BiomePoolTier.UNCOMMON]: {
    [TimeOfDay.ALL]: [SpeciesId.SLOWKING, SpeciesId.SNEASEL, SpeciesId.SMOOCHUM, SpeciesId.SPHEAL, SpeciesId.EISCUE, SpeciesId.CETODDLE],
    [TimeOfDay.DAWN]: [],
    [TimeOfDay.DAY]: [],
    [TimeOfDay.DUSK]: [],
    [TimeOfDay.NIGHT]: [],
...
export const iceCaveBiome: Biome = {
  biomeId: BiomeId.ICE_CAVE,
  pokemonPool,
  trainerPool,
  trainerChance: 12,
  weatherPool,
