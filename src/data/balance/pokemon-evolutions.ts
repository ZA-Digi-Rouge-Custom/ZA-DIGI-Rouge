...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [SpeciesId.PIKACHU]: [
    ...
    new SpeciesFormEvolution(SpeciesId.GOROCHU, "", "", 1, EvolutionItem.FIRE_STONE, null, [30, 35, 40]),
    new SpeciesFormEvolution(SpeciesId.GOROCHU, "partner", "", 1, EvolutionItem.FIRE_STONE, null, [30, 35, 40]),
  ],
  [SpeciesId.NIDORINA]: [
...
,
              [SpeciesId.BOTAMON]: [
    new SpeciesEvolution(SpeciesId.KOROMON, 7, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY]}),
    new SpeciesEvolution(SpeciesId.TSUNOMON, 7, null, {key: EvoCondKey.TIME, time: [TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.PAGUMON, 7, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.MOTIMON, 7, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK]})
  ],

                [SpeciesId.KOROMON]: [
    new SpeciesEvolution(SpeciesId.AGUMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY]}),
    new SpeciesEvolution(SpeciesId.BETAMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.PATAMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK]}),
    new SpeciesEvolution(SpeciesId.BIYOMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.VMON, 1, EvolutionItem.DRAGON_SCALE, null)
  ],

                [SpeciesId.AGUMON]: [
    new SpeciesEvolution(SpeciesId.GREYMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY]}),
    new SpeciesEvolution(SpeciesId.TYRANNOMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.OGREMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.MONOCHROMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK]}),
    new SpeciesEvolution(SpeciesId.NUMEMON, 1, EvolutionItem.DAWN_STONE, null)
  ],

            [SpeciesId.GREYMON]: [
    new SpeciesEvolution(SpeciesId.METALGREYMON, 48, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.SKULLGREYMON, 16, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]})
  ],

    [SpeciesId.METALGREYMON]: [
    new SpeciesEvolution(SpeciesId.WARGREYMON, 76, null, null)
  ],

  [SpeciesId.WARGREYMON]: [
    new SpeciesEvolution(SpeciesId.OMNIMON, 1, EvolutionItem.ICE_STONE, null)
  ],

  [SpeciesId.SKULLGREYMON]: [
    new SpeciesEvolution(SpeciesId.MACHINEDRAGMON, 100, null, null)
  ],

      [SpeciesId.BETAMON]: [
    new SpeciesEvolution(SpeciesId.SEADRAMON, 24, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.SHELLMON, 24, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.NUMEMON, 1, EvolutionItem.DAWN_STONE, null)
  ],

    [SpeciesId.SEADRAMON]: [
    new SpeciesEvolution(SpeciesId.MEGASEADRAMON, 48, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN, TimeOfDay.DAY, TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.METALSEADRAMON, 76, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK]})
  ],

  [SpeciesId.NUMEMON]: [
    new SpeciesEvolution(SpeciesId.MONZAEMON, 48, null, null)
  ],

        [SpeciesId.PALMON]: [
    new SpeciesEvolution(SpeciesId.WOODMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.NIGHT, TimeOfDay.DUSK]}),
    new SpeciesEvolution(SpeciesId.TOGEMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.VEGIEMON, 1, EvolutionItem.LEAF_STONE, null),
    new SpeciesEvolution(SpeciesId.REDVEGIEMON, 1, EvolutionItem.SUN_STONE, null),
    new SpeciesEvolution(SpeciesId.NUMEMON, 1, EvolutionItem.DAWN_STONE, null)
  ],

      [SpeciesId.TOGEMON]: [
    new SpeciesEvolution(SpeciesId.LILLYMON, 48, null, {key: EvoCondKey.GENDER, gender: Gender.FEMALE})
  ],

    [SpeciesId.TSUNOMON]: [
    new SpeciesEvolution(SpeciesId.GABUMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.GOMAMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.ELECMON, 1, EvolutionItem.THUNDER_STONE, null)
  ],

    [SpeciesId.MOTIMON]: [
    new SpeciesEvolution(SpeciesId.PALMON, 1, EvolutionItem.LEAF_STONE, null),
    new SpeciesEvolution(SpeciesId.TENTOMON, 16, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.KUNEMON, 16, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.CRABMON, 1, EvolutionItem.WATER_STONE, null)
  ],

              [SpeciesId.GABUMON]: [
    new SpeciesEvolution(SpeciesId.OGREMON, 16, null, {key: EvoCondKey.TIME, time: [TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.MONOCHROMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY]}),
    new SpeciesEvolution(SpeciesId.GARURUMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN, TimeOfDay.DUSK]}),
    new SpeciesEvolution(SpeciesId.FRIGIMON, 1, EvolutionItem.ICE_STONE, null),
    new SpeciesEvolution(SpeciesId.NUMEMON, 1, EvolutionItem.DAWN_STONE, null)
  ],

        [SpeciesId.ELECMON]: [
    new SpeciesEvolution(SpeciesId.LEOMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.MOJYAMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY]}),
    new SpeciesEvolution(SpeciesId.DRIMOGEMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.UNIMON, 1, EvolutionItem.DAWN_STONE, null)
  ],

      [SpeciesId.GOMAMON]: [
    new SpeciesEvolution(SpeciesId.FRIGIMON, 1, EvolutionItem.ICE_STONE, null),
    new SpeciesEvolution(SpeciesId.IKKAKUMON, 1, EvolutionItem.WATER_STONE, null),
    new SpeciesEvolution(SpeciesId.MOJYAMON, 1, EvolutionItem.DAWN_STONE, null)
  ],

    [SpeciesId.CRABMON]: [
    new SpeciesEvolution(SpeciesId.COELAMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.SHELLMON, 30, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]})
  ],

      [SpeciesId.KUNEMON]: [
    new SpeciesEvolution(SpeciesId.KUWAGAMON, 24, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.FLYMON, 20, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]})
  ],

    [SpeciesId.TENTOMON]: [
    new SpeciesEvolution(SpeciesId.KUWAGAMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.KABUTERIMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]})
  ],

  [SpeciesId.BIYOMON]: [
    new SpeciesEvolution(SpeciesId.AIRDRAMON, 1, EvolutionItem.DRAGON_SCALE, null),
    new SpeciesEvolution(SpeciesId.BIRDRAMON, 1, EvolutionItem.RAZOR_CLAW, null),
    new SpeciesEvolution(SpeciesId.UNIMON, 26, null, null)
  ],

    [SpeciesId.PATAMON]: [
    new SpeciesEvolution(SpeciesId.AIRDRAMON, 1, EvolutionItem.DRAGON_SCALE, null),
    new SpeciesEvolution(SpeciesId.ANGEMON, 1, EvolutionItem.AUSPICIOUS_ARMOR, null),
    new SpeciesEvolution(SpeciesId.UNIMON, 26, null, null)
  ],

  [SpeciesId.BIRDRAMON]: [
    new SpeciesEvolution(SpeciesId.GARUDAMON, 48, null, null)
  ],

  [SpeciesId.GARURUMON]: [
    new SpeciesEvolution(SpeciesId.WEREGARURUMON, 48, null, null)
  ],

  [SpeciesId.UNIMON]: [
    new SpeciesEvolution(SpeciesId.PIXIMON, 48, null, null)
  ],

  [SpeciesId.LEOMON]: [
    new SpeciesEvolution(SpeciesId.SABERLEOMON, 78, null, null)
  ],

  [SpeciesId.IKKAKUMON]: [
    new SpeciesEvolution(SpeciesId.ZUDOMON, 48, null, null)
  ],
  ...
  [SpeciesId.KUWAGAMON]: [
    new SpeciesEvolution(SpeciesId.OKUWAMON, 48, null, null)
  ],

  [SpeciesId.KABUTERIMON]: [
    new SpeciesEvolution(SpeciesId.MEGAKABUTERIMON, 48, null, null)
  ],

    [SpeciesId.COELAMON]: [
    new SpeciesEvolution(SpeciesId.WHAMON, 48, null, null)
  ],

      [SpeciesId.ANGEMON]: [
    new SpeciesEvolution(SpeciesId.MAGNAANGEMON, 1, EvolutionItem.SHINY_STONE, null),
    new SpeciesEvolution(SpeciesId.ANGEWOMON, 48, null, {key: EvoCondKey.GENDER, gender: Gender.FEMALE})
  ],

  [SpeciesId.WEREGARURUMON]: [
    new SpeciesEvolution(SpeciesId.METALGARURUMON, 76, null, null)
  ],

  [SpeciesId.METALGARURUMON]: [
    new SpeciesEvolution(SpeciesId.OMNIMON, 1, EvolutionItem.FIRE_STONE, null)
  ],

        [SpeciesId.PAGUMON]: [
    new SpeciesEvolution(SpeciesId.GAZIMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN]}),
    new SpeciesEvolution(SpeciesId.DEMIDEVIMON, 12, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK]}),
    new SpeciesEvolution(SpeciesId.KERAMON, 48, null, {key: EvoCondKey.FRIENDSHIP, value: 120})
  ],

    [SpeciesId.GAZIMON]: [
    new SpeciesEvolution(SpeciesId.LEOMON, 32, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN, TimeOfDay.DUSK]}),
    new SpeciesEvolution(SpeciesId.ETEMON, 48, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAY, TimeOfDay.NIGHT]})
  ],

  [SpeciesId.ETEMON]: [
    new SpeciesEvolution(SpeciesId.METALETEMON, 1, EvolutionItem.METAL_ALLOY, null)
  ],

          [SpeciesId.DEMIDEVIMON]: [
    new SpeciesEvolution(SpeciesId.WIZARDMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.DEVIMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK]}),
    new SpeciesEvolution(SpeciesId.BAKEMON, 26, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN]})
  ],

      [SpeciesId.DEVIMON]: [
    new SpeciesEvolution(SpeciesId.MYOTISMON, 60, null, {key: EvoCondKey.GENDER, gender: Gender.MALE}),
    new SpeciesEvolution(SpeciesId.LADYDEVILMON, 60, null, {key: EvoCondKey.GENDER, gender: Gender.FEMALE})
  ],

  [SpeciesId.BAKEMON]: [
    new SpeciesEvolution(SpeciesId.PHANTOMON, 60, null, null)
  ],

  [SpeciesId.KERAMON]: [
    new SpeciesEvolution(SpeciesId.INFERMON, 1, EvolutionItem.UPGRADE, null)
  ],

  [SpeciesId.INFERMON]: [
    new SpeciesEvolution(SpeciesId.DIABOROMON, 1, EvolutionItem.DUBIOUS_DISC, null)
  ],

  [SpeciesId.WOODMON]: [
    new SpeciesEvolution(SpeciesId.CHERRYMON, 1, EvolutionItem.STRAWBERRY_SWEET, null)
  ],

  [SpeciesId.CHERRYMON]: [
    new SpeciesEvolution(SpeciesId.PUPPETMON, 1, EvolutionItem.DUSK_STONE, null)
  ],

  [SpeciesId.PHANTOMON]: [
    new SpeciesEvolution(SpeciesId.PIEDMON, 1, EvolutionItem.DUBIOUS_DISC, null)
  ],

  [SpeciesId.VMON]: [
    new SpeciesEvolution(SpeciesId.XVMON, 24, null, null)
  ],

  [SpeciesId.XVMON]: [
    new SpeciesEvolution(SpeciesId.FILEDRAMON, 48, null, null)
  ],

  [SpeciesId.FILEDRAMON]: [
    new SpeciesEvolution(SpeciesId.IMPERIALDRAMON, 74, null, null)
  ],
