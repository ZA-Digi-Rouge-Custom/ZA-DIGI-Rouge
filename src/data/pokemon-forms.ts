...
export const pokemonFormChanges: PokemonFormChanges = {
  [SpeciesId.VENUSAUR]: [
    new SpeciesFormChange(SpeciesId.VENUSAUR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.BLASTOISE]: [
    new SpeciesFormChange(SpeciesId.BLASTOISE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CHARIZARD]: [
    new SpeciesFormChange(SpeciesId.CHARIZARD, "", SpeciesFormKey.MEGA_X, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.BUTTERFREE]: [
    new SpeciesFormChange(SpeciesId.BUTTERFREE, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.BEEDRILL]: [
    new SpeciesFormChange(SpeciesId.BEEDRILL, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.BEEDRILL, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.BEEDRILLITE))
  ],
  [SpeciesId.PIDGEOT]: [
    new SpeciesFormChange(SpeciesId.PIDGEOT, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.PIDGEOT, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.PIDGEOTITE))
  ],
  [SpeciesId.PIKACHU]: [
    new SpeciesFormChange(SpeciesId.PIKACHU, "", "partner", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.MEOWTH]: [
    new SpeciesFormChange(SpeciesId.MEOWTH, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ALAKAZAM]: [
    new SpeciesFormChange(SpeciesId.ALAKAZAM, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.ALAKAZAM, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.ALAKAZITE))
  ],
  [SpeciesId.MACHAMP]: [
    new SpeciesFormChange(SpeciesId.MACHAMP, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.SLOWBRO]: [
    new SpeciesFormChange(SpeciesId.SLOWBRO, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.SLOWBRO, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.SLOWBRONITE))
  ],
  [SpeciesId.GENGAR]: [
    new SpeciesFormChange(SpeciesId.GENGAR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.KINGLER]: [
    new SpeciesFormChange(SpeciesId.KINGLER, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.KANGASKHAN]: [
    new SpeciesFormChange(SpeciesId.KANGASKHAN, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.PINSIR]: [
    new SpeciesFormChange(SpeciesId.PINSIR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.PINSIR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.PINSIRITE))
  ],
  [SpeciesId.GYARADOS]: [
    new SpeciesFormChange(SpeciesId.GYARADOS, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.GYARADOS, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.GYARADOSITE))
  ],
  [SpeciesId.LAPRAS]: [
    new SpeciesFormChange(SpeciesId.LAPRAS, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.EEVEE]: [
    new SpeciesFormChange(SpeciesId.EEVEE, "", "partner", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.SNORLAX]: [
    new SpeciesFormChange(SpeciesId.SNORLAX, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.AERODACTYL]: [
    new SpeciesFormChange(SpeciesId.AERODACTYL, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.MEWTWO]: [
    new SpeciesFormChange(SpeciesId.MEWTWO, "", SpeciesFormKey.MEGA_X, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.AMPHAROS]: [
    new SpeciesFormChange(SpeciesId.AMPHAROS, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.AMPHAROS, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.AMPHAROSITE))
  ],
  [SpeciesId.STEELIX]: [
    new SpeciesFormChange(SpeciesId.STEELIX, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.STEELIX, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.STEELIXITE))
  ],
  [SpeciesId.SCIZOR]: [
    new SpeciesFormChange(SpeciesId.SCIZOR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.SCIZOR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.SCIZORITE))
  ],
  [SpeciesId.HERACROSS]: [
    new SpeciesFormChange(SpeciesId.HERACROSS, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.HOUNDOOM]: [
    new SpeciesFormChange(SpeciesId.HOUNDOOM, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.TYRANITAR]: [
    new SpeciesFormChange(SpeciesId.TYRANITAR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.SCEPTILE]: [
    new SpeciesFormChange(SpeciesId.SCEPTILE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.SCEPTILE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.SCEPTILITE))
  ],
  [SpeciesId.BLAZIKEN]: [
    new SpeciesFormChange(SpeciesId.BLAZIKEN, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.BLAZIKEN, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.BLAZIKENITE))
  ],
  [SpeciesId.SWAMPERT]: [
    new SpeciesFormChange(SpeciesId.SWAMPERT, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.SWAMPERT, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.SWAMPERTITE))
  ],
  [SpeciesId.GARDEVOIR]: [
    new SpeciesFormChange(SpeciesId.GARDEVOIR, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CAMERUPT]: [
    new SpeciesFormChange(SpeciesId.CAMERUPT, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.CAMERUPT, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.CAMERUPTITE))
  ],
  [SpeciesId.ALTARIA]: [
    new SpeciesFormChange(SpeciesId.ALTARIA, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.ALTARIA, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.ALTARIANITE))
  ],
  [SpeciesId.CASTFORM]: [
    new SpeciesFormChange(SpeciesId.CASTFORM, "", "sunny", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.BANETTE]: [
    new SpeciesFormChange(SpeciesId.BANETTE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.GLALIE]: [
    new SpeciesFormChange(SpeciesId.GLALIE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.GLALIE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.GLALITITE))
  ],
  [SpeciesId.SALAMENCE]: [
    new SpeciesFormChange(SpeciesId.SALAMENCE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.METAGROSS]: [
    new SpeciesFormChange(SpeciesId.METAGROSS, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CHERRIM]: [
    new SpeciesFormChange(SpeciesId.CHERRIM, "overcast", "sunshine", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.LOPUNNY]: [
    new SpeciesFormChange(SpeciesId.LOPUNNY, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.LOPUNNY, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.LOPUNNITE))
  ],
  [SpeciesId.GARCHOMP]: [
    new SpeciesFormChange(SpeciesId.GARCHOMP, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.LUCARIO]: [
    new SpeciesFormChange(SpeciesId.LUCARIO, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ABOMASNOW]: [
    new SpeciesFormChange(SpeciesId.ABOMASNOW, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.ABOMASNOW, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.ABOMASITE))
  ],
  [SpeciesId.GALLADE]: [
    new SpeciesFormChange(SpeciesId.GALLADE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.GALLADE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.GALLADITE))
  ],
  [SpeciesId.AUDINO]: [
    new SpeciesFormChange(SpeciesId.AUDINO, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.AUDINO, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.AUDINITE))
  ],
  [SpeciesId.DIALGA]: [
    new SpeciesFormChange(SpeciesId.DIALGA, "", "origin", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.PALKIA]: [
    new SpeciesFormChange(SpeciesId.PALKIA, "", "origin", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.GIRATINA]: [
    new SpeciesFormChange(SpeciesId.GIRATINA, "altered", "origin", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.SHAYMIN]: [
    new SpeciesFormChange(SpeciesId.SHAYMIN, "land", "sky", new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.SHAYMIN, "land", "sky", new SpeciesFormChangeItemTrigger(FormChangeItem.GRACIDEA))
  ],
  [SpeciesId.ARCEUS]: [
    new SpeciesFormChange(SpeciesId.ARCEUS, "normal", "fighting", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.DARMANITAN]: [
    new SpeciesFormChange(SpeciesId.DARMANITAN, "", "zen", new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.DARMANITAN, "", "zen", new SpeciesFormChangeAbilityTrigger(), true),
    new SpeciesFormChange(SpeciesId.DARMANITAN, "zen", "", new SpeciesFormChangeAbilityTrigger(), true)
  ],
  [SpeciesId.GARBODOR]: [
    new SpeciesFormChange(SpeciesId.GARBODOR, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.TORNADUS]: [
    new SpeciesFormChange(SpeciesId.TORNADUS, "incarnate", "therian", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.THUNDURUS]: [
    new SpeciesFormChange(SpeciesId.THUNDURUS, "incarnate", "therian", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.LANDORUS]: [
    new SpeciesFormChange(SpeciesId.LANDORUS, "incarnate", "therian", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.KYUREM]: [
    new SpeciesFormChange(SpeciesId.KYUREM, "", "black", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.KELDEO]: [
    new SpeciesFormChange(SpeciesId.KELDEO, "ordinary", "resolute", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.MELOETTA]: [
    new SpeciesFormChange(SpeciesId.MELOETTA, "aria", "pirouette", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.GENESECT]: [
    new SpeciesFormChange(SpeciesId.GENESECT, "", "shock", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.GRENINJA]: [
    new SpeciesFormChange(SpeciesId.GRENINJA, "", "battle-bond", new SpeciesFormChangeManualTrigger()),
    ...
    new SpeciesFormChange(SpeciesId.GRENINJA, "battle-bond", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.GRENINJITE)),
    new SpeciesFormChange(SpeciesId.GRENINJA, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.GRENINJITE)),
  ],
  [SpeciesId.PALAFIN] : [
    new SpeciesFormChange(SpeciesId.PALAFIN, "zero", "hero", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.AEGISLASH]: [
    new SpeciesFormChange(SpeciesId.AEGISLASH, "shield", "blade", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.XERNEAS]: [
    new SpeciesFormChange(SpeciesId.XERNEAS, "neutral", "active", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ZYGARDE]: [
    new SpeciesFormChange(SpeciesId.ZYGARDE, "50", "10", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.DIANCIE]: [
    new SpeciesFormChange(SpeciesId.DIANCIE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.DIANCIE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.DIANCITE))
  ],
  [SpeciesId.HOOPA]: [
    new SpeciesFormChange(SpeciesId.HOOPA, "", "unbound", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.WISHIWASHI]: [
    new SpeciesFormChange(SpeciesId.WISHIWASHI, "", "school", new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.WISHIWASHI, "", "school", new SpeciesFormChangeAbilityTrigger(), true),
    new SpeciesFormChange(SpeciesId.WISHIWASHI, "school", "", new SpeciesFormChangeAbilityTrigger(), true)
  ],
  [SpeciesId.SILVALLY]: [
    new SpeciesFormChange(SpeciesId.SILVALLY, "normal", "fighting", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.MINIOR]: [
    new SpeciesFormChange(SpeciesId.MINIOR, "red-meteor", "orange-meteor", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.MIMIKYU]: [
    new SpeciesFormChange(SpeciesId.MIMIKYU, "disguised", "busted", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.NECROZMA]: [
    new SpeciesFormChange(SpeciesId.NECROZMA, "", "dusk-mane", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.MELMETAL]: [
    new SpeciesFormChange(SpeciesId.MELMETAL, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.RILLABOOM]: [
    new SpeciesFormChange(SpeciesId.RILLABOOM, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CINDERACE]: [
    new SpeciesFormChange(SpeciesId.CINDERACE, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.INTELEON]: [
    new SpeciesFormChange(SpeciesId.INTELEON, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CORVIKNIGHT]: [
    new SpeciesFormChange(SpeciesId.CORVIKNIGHT, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ORBEETLE]: [
    new SpeciesFormChange(SpeciesId.ORBEETLE, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.DREDNAW]: [
    new SpeciesFormChange(SpeciesId.DREDNAW, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.COALOSSAL]: [
    new SpeciesFormChange(SpeciesId.COALOSSAL, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.FLAPPLE]: [
    new SpeciesFormChange(SpeciesId.FLAPPLE, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.APPLETUN]: [
    new SpeciesFormChange(SpeciesId.APPLETUN, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.SANDACONDA]: [
    new SpeciesFormChange(SpeciesId.SANDACONDA, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CRAMORANT]: [
    new SpeciesFormChange(SpeciesId.CRAMORANT, "", "gulping", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.TOXTRICITY]: [
    new SpeciesFormChange(SpeciesId.TOXTRICITY, "amped", "lowkey", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CENTISKORCH]: [
    new SpeciesFormChange(SpeciesId.CENTISKORCH, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.HATTERENE]: [
    new SpeciesFormChange(SpeciesId.HATTERENE, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.GRIMMSNARL]: [
    new SpeciesFormChange(SpeciesId.GRIMMSNARL, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ALCREMIE]: [
    new SpeciesFormChange(SpeciesId.ALCREMIE, "vanilla-cream", "ruby-cream", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.EISCUE]: [
    new SpeciesFormChange(SpeciesId.EISCUE, "", "no-ice", new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.EISCUE, "", "no-ice", new SpeciesFormChangeAbilityTrigger(), true),
    new SpeciesFormChange(SpeciesId.EISCUE, "no-ice", "", new SpeciesFormChangeAbilityTrigger(), true)
  ],
  [SpeciesId.MORPEKO]: [
    new SpeciesFormChange(SpeciesId.MORPEKO, "full-belly", "hangry", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.COPPERAJAH]: [
    new SpeciesFormChange(SpeciesId.COPPERAJAH, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.DURALUDON]: [
    new SpeciesFormChange(SpeciesId.DURALUDON, "", SpeciesFormKey.GIGANTAMAX, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ZACIAN]: [
    new SpeciesFormChange(SpeciesId.ZACIAN, "hero-of-many-battles", "crowned", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ZAMAZENTA]: [
    new SpeciesFormChange(SpeciesId.ZAMAZENTA, "hero-of-many-battles", "crowned", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ETERNATUS]: [
    new SpeciesFormChange(SpeciesId.ETERNATUS, "", "eternamax", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.URSHIFU]: [
    new SpeciesFormChange(SpeciesId.URSHIFU, "single-strike", "rapid-strike", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.CALYREX]: [
    new SpeciesFormChange(SpeciesId.CALYREX, "", "ice", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.ENAMORUS]: [
    new SpeciesFormChange(SpeciesId.ENAMORUS, "incarnate", "therian", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.OGERPON]: [
    new SpeciesFormChange(SpeciesId.OGERPON, "teal-mask", "wellspring-mask", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.TERAPAGOS]: [
    new SpeciesFormChange(SpeciesId.TERAPAGOS, "", "terastal", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.GALAR_DARMANITAN]: [
    new SpeciesFormChange(SpeciesId.GALAR_DARMANITAN, "", "zen", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.BASCULEGION]: [
    new SpeciesFormChange(SpeciesId.BASCULEGION, "male", "female", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.BASCULIN]: [
    new SpeciesFormChange(SpeciesId.BASCULIN, "red-striped", "blue-striped", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.CRABOMINABLE]: [
    new SpeciesFormChange(SpeciesId.CRABOMINABLE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.DUDUNSPARCE]: [
    new SpeciesFormChange(SpeciesId.DUDUNSPARCE, "two-segment", "three-segment", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.FLORGES]: [
    new SpeciesFormChange(SpeciesId.FLORGES, "red", "yellow", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.FURFROU]: [
    new SpeciesFormChange(SpeciesId.FURFROU, "", "heart", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.GASTRODON]: [
    new SpeciesFormChange(SpeciesId.GASTRODON, "east", "west", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.GIMMIGHOUL]: [
    new SpeciesFormChange(SpeciesId.GIMMIGHOUL, "chest", "roaming", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.GOURGEIST]: [
    new SpeciesFormChange(SpeciesId.GOURGEIST, "", "small", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.INDEEDEE]: [
    new SpeciesFormChange(SpeciesId.INDEEDEE, "male", "female", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.LYCANROC]: [
    new SpeciesFormChange(SpeciesId.LYCANROC, "midday", "midnight", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.MAGEARNA]: [
    new SpeciesFormChange(SpeciesId.MAGEARNA, "", "original", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.MARSHADOW]: [
    new SpeciesFormChange(SpeciesId.MARSHADOW, "", "zenith", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.MAUSHOLD]: [
    new SpeciesFormChange(SpeciesId.MAUSHOLD, "four", "three", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.MEOWSTIC]: [
    new SpeciesFormChange(SpeciesId.MEOWSTIC, "male", "female", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.OINKOLOGNE]: [
    new SpeciesFormChange(SpeciesId.OINKOLOGNE, "male", "female", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.ORICORIO]: [
    new SpeciesFormChange(SpeciesId.ORICORIO, "baile", "pompom", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.PALDEA_TAUROS]: [
    new SpeciesFormChange(SpeciesId.PALDEA_TAUROS, "combat", "blaze", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.PICHU]: [
    new SpeciesFormChange(SpeciesId.PICHU, "", "spiky", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.POLTCHAGEIST]: [
    new SpeciesFormChange(SpeciesId.POLTCHAGEIST, "counterfeit", "artisan", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.POLTEAGEIST]: [
    new SpeciesFormChange(SpeciesId.POLTEAGEIST, "phony", "antique", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.REVAVROOM]: [
    new SpeciesFormChange(SpeciesId.REVAVROOM, "", "segin-starmobile", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.ROCKRUFF]: [
    new SpeciesFormChange(SpeciesId.ROCKRUFF, "", "own-tempo", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.ROTOM]: [
    new SpeciesFormChange(SpeciesId.ROTOM, "", "heat", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.SAWSBUCK]: [
    new SpeciesFormChange(SpeciesId.SAWSBUCK, "spring", "summer", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.SINISTCHA]: [
    new SpeciesFormChange(SpeciesId.SINISTCHA, "unremarkable", "masterpiece", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.SINISTEA]: [
    new SpeciesFormChange(SpeciesId.SINISTEA, "phony", "antique", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.SQUAWKABILLY]: [
    new SpeciesFormChange(SpeciesId.SQUAWKABILLY, "green-plumage", "blue-plumage", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.STARMIE]: [
    new SpeciesFormChange(SpeciesId.STARMIE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeManualTrigger()),
    new SpeciesFormChange(SpeciesId.STARMIE, "", SpeciesFormKey.MEGA, new SpeciesFormChangeItemTrigger(FormChangeItem.STARMINITE)),
  ],

  [SpeciesId.TATSUGIRI]: [
    new SpeciesFormChange(SpeciesId.TATSUGIRI, "curly", "droopy", new SpeciesFormChangeManualTrigger()),
  ...
  [SpeciesId.UNOWN]: [
    new SpeciesFormChange(SpeciesId.UNOWN, "a", "b", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.VIVILLON]: [
    new SpeciesFormChange(SpeciesId.VIVILLON, "meadow", "icy-snow", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.WORMADAM]: [
    new SpeciesFormChange(SpeciesId.WORMADAM, "plant", "sandy", new SpeciesFormChangeManualTrigger())
  ],

  [SpeciesId.ZARUDE]: [
    new SpeciesFormChange(SpeciesId.ZARUDE, "", "dada", new SpeciesFormChangeManualTrigger())
  ],
  ...
  [SpeciesId.IMPERIALDRAMON]: [
    new SpeciesFormChange(SpeciesId.IMPERIALDRAMON, "", "fighter", new SpeciesFormChangeItemTrigger(FormChangeItem.DRACO_PLATE)),
  ],
};
