...
export const trainerConfigs: TrainerConfigs = {
  ...
  [TrainerType.AROMA_LADY]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.ODDISH, SpeciesId.BELLSPROUT, SpeciesId.SHROOMISH, SpeciesId.BUDEW, SpeciesId.CHERUBI, SpeciesId.SCATTERBUG, SpeciesId.FLABEBE, SpeciesId.SPRITZEE, SpeciesId.SWIRLIX],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.PARAS, SpeciesId.COMBEE, SpeciesId.PETILIL, SpeciesId.CUTIEFLY, SpeciesId.BOUNSWEET, SpeciesId.GOSSIFLEUR, SpeciesId.LECHONK, SpeciesId.FIDOUGH, SpeciesId.SMOLIV],
      [TrainerPoolTier.RARE]: [SpeciesId.TROPIUS, SpeciesId.COMFEY, SpeciesId.SALANDIT, SpeciesId.SINISTEA, SpeciesId.POLTCHAGEIST, SpeciesId.MILCERY, SpeciesId.APPLETUN, SpeciesId.GALAR_WEEZING],
  ...
  [TrainerType.ARTIST]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.SMEARGLE],
    }),
  ...
  [TrainerType.BACKPACKER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.RHYHORN, SpeciesId.AIPOM, SpeciesId.MAKUHITA, SpeciesId.MAWILE, SpeciesId.NUMEL, SpeciesId.LILLIPUP, SpeciesId.SANDILE, SpeciesId.WOOLOO],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.GIRAFARIG, SpeciesId.ZANGOOSE, SpeciesId.SEVIPER, SpeciesId.CUBCHOO, SpeciesId.PANCHAM, SpeciesId.SKIDDO, SpeciesId.MUDBRAY],
      [TrainerPoolTier.RARE]: [SpeciesId.TAUROS, SpeciesId.STANTLER, SpeciesId.DARUMAKA, SpeciesId.BOUFFALANT, SpeciesId.DEERLING, SpeciesId.IMPIDIMP],
  ...
  [TrainerType.BEAUTY]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.MEOWTH, SpeciesId.GOLDEEN, SpeciesId.MAREEP, SpeciesId.MARILL, SpeciesId.SKITTY, SpeciesId.GLAMEOW, SpeciesId.PURRLOIN],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.SMOOCHUM, SpeciesId.ROSELIA, SpeciesId.LUVDISC, SpeciesId.BLITZLE, SpeciesId.SEWADDLE, SpeciesId.PETILIL, SpeciesId.MINCCINO, SpeciesId.GOTHITA, SpeciesId.SPRITZEE, SpeciesId.FLITTLE],
      [TrainerPoolTier.RARE]: [SpeciesId.FEEBAS, SpeciesId.FURFROU, SpeciesId.SALANDIT, SpeciesId.BRUXISH, SpeciesId.HATENNA, SpeciesId.SNOM, SpeciesId.ALOLA_VULPIX],
      [TrainerPoolTier.SUPER_RARE]: [SpeciesId.CLAMPERL, SpeciesId.AMAURA, SpeciesId.SYLVEON, SpeciesId.GOOMY, SpeciesId.POPPLIO],
    }),
  [TrainerType.BIKER]:  new TrainerConfig(++t)
    .setMoneyMultiplier(1.4)
    .setEncounterBgm(TrainerType.ROUGHNECK)
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.EKANS, SpeciesId.KOFFING, SpeciesId.CROAGUNK, SpeciesId.VENIPEDE, SpeciesId.SCRAGGY],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.GRIMER, SpeciesId.VOLTORB, SpeciesId.TEDDIURSA, SpeciesId.MAGBY, SpeciesId.SKORUPI, SpeciesId.SANDILE, SpeciesId.PAWNIARD, SpeciesId.SHROODLE],
  ...
  [TrainerType.BIRD_KEEPER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.PIDGEY, SpeciesId.SPEAROW, SpeciesId.DODUO, SpeciesId.TAILLOW, SpeciesId.STARLY, SpeciesId.PIDOVE, SpeciesId.DUCKLETT, SpeciesId.FLETCHLING, SpeciesId.PIKIPEK, SpeciesId.SQUAWKABILLY],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.FARFETCHD, SpeciesId.HOOTHOOT, SpeciesId.NATU, SpeciesId.MURKROW, SpeciesId.WINGULL, SpeciesId.SWABLU, SpeciesId.CHATOT, SpeciesId.RUFFLET, SpeciesId.VULLABY, SpeciesId.ORICORIO, SpeciesId.ROOKIDEE, SpeciesId.WATTREL],
      [TrainerPoolTier.RARE]: [SpeciesId.TOGEPI, SpeciesId.DELIBIRD, SpeciesId.SKARMORY, SpeciesId.HAWLUCHA, SpeciesId.CRAMORANT, SpeciesId.EISCUE, SpeciesId.FLAMIGO, SpeciesId.FLITTLE, SpeciesId.BOMBIRDIER],
      [TrainerPoolTier.SUPER_RARE]: [SpeciesId.AERODACTYL, SpeciesId.TORCHIC, SpeciesId.PIPLUP, SpeciesId.ARCHEN, SpeciesId.ROWLET, SpeciesId.QUAXLY, SpeciesId.GALAR_FARFETCHD],
      [TrainerPoolTier.ULTRA_RARE]: [SpeciesId.ARTICUNO, SpeciesId.ZAPDOS, SpeciesId.MOLTRES, SpeciesId.GALAR_ARTICUNO, SpeciesId.GALAR_ZAPDOS, SpeciesId.GALAR_MOLTRES],
    }),
  [TrainerType.BLACK_BELT]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.NIDORAN_F, SpeciesId.NIDORAN_M, SpeciesId.MACHOP, SpeciesId.MAKUHITA, SpeciesId.MEDITITE, SpeciesId.CROAGUNK, SpeciesId.TIMBURR],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.MANKEY, SpeciesId.POLIWRATH, SpeciesId.TYROGUE, SpeciesId.BRELOOM, SpeciesId.SCRAGGY, SpeciesId.MIENFOO, SpeciesId.PANCHAM, SpeciesId.STUFFUL, SpeciesId.CRABRAWLER],
      [TrainerPoolTier.RARE]: [SpeciesId.HERACROSS, SpeciesId.RIOLU, SpeciesId.THROH, SpeciesId.SAWK, SpeciesId.PASSIMIAN, SpeciesId.CLOBBOPUS],
      [TrainerPoolTier.SUPER_RARE]: [SpeciesId.HITMONTOP, SpeciesId.INFERNAPE, SpeciesId.GALLADE, SpeciesId.HAWLUCHA, SpeciesId.HAKAMO_O],
  ...
  [TrainerType.BREEDER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.PICHU, SpeciesId.CLEFFA, SpeciesId.IGGLYBUFF, SpeciesId.TOGEPI, SpeciesId.TYROGUE, SpeciesId.SMOOCHUM, SpeciesId.AZURILL, SpeciesId.BUDEW, SpeciesId.CHINGLING, SpeciesId.BONSLY, SpeciesId.MIME_JR, SpeciesId.HAPPINY, SpeciesId.MANTYKE, SpeciesId.TOXEL],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.DITTO, SpeciesId.ELEKID, SpeciesId.MAGBY, SpeciesId.WYNAUT, SpeciesId.MUNCHLAX, SpeciesId.RIOLU, SpeciesId.AUDINO],
      [TrainerPoolTier.RARE]: [SpeciesId.ALOLA_RATTATA, SpeciesId.ALOLA_SANDSHREW, SpeciesId.ALOLA_VULPIX, SpeciesId.ALOLA_DIGLETT, SpeciesId.ALOLA_MEOWTH, SpeciesId.GALAR_PONYTA],
      [TrainerPoolTier.SUPER_RARE]: [SpeciesId.ALOLA_GEODUDE, SpeciesId.ALOLA_GRIMER, SpeciesId.GALAR_MEOWTH, SpeciesId.GALAR_SLOWPOKE, SpeciesId.GALAR_FARFETCHD, SpeciesId.HISUI_GROWLITHE, SpeciesId.HISUI_VOLTORB, SpeciesId.HISUI_QWILFISH, SpeciesId.HISUI_SNEASEL, SpeciesId.HISUI_ZORUA],
    }),
  ...
  [TrainerType.CLERK]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.MEOWTH, SpeciesId.PSYDUCK, SpeciesId.BUDEW, SpeciesId.PIDOVE, SpeciesId.CINCCINO, SpeciesId.LITLEO],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.JIGGLYPUFF, SpeciesId.MAGNEMITE, SpeciesId.MARILL, SpeciesId.COTTONEE, SpeciesId.SKIDDO],
  ...
  [TrainerType.CYCLIST]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.DODUO, SpeciesId.PICHU, SpeciesId.TAILLOW, SpeciesId.STARLY, SpeciesId.PONYTA],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.ELECTRIKE, SpeciesId.SHINX, SpeciesId.BLITZLE, SpeciesId.DUCKLETT, SpeciesId.WATTREL],
      [TrainerPoolTier.RARE]: [SpeciesId.YANMA, SpeciesId.NINJASK, SpeciesId.VENIPEDE, SpeciesId.EMOLGA, SpeciesId.SKIDDO, SpeciesId.ROLYCOLY],
  ...
  [TrainerType.FISHERMAN]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.TENTACOOL, SpeciesId.MAGIKARP, SpeciesId.GOLDEEN, SpeciesId.STARYU, SpeciesId.REMORAID, SpeciesId.SKRELP, SpeciesId.CLAUNCHER, SpeciesId.ARROKUDA],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.POLIWAG, SpeciesId.SHELLDER, SpeciesId.KRABBY, SpeciesId.HORSEA, SpeciesId.CARVANHA, SpeciesId.BARBOACH, SpeciesId.CORPHISH, SpeciesId.FINNEON, SpeciesId.TYMPOLE, SpeciesId.BASCULIN, SpeciesId.FRILLISH, SpeciesId.INKAY],
      [TrainerPoolTier.RARE]: [SpeciesId.CHINCHOU, SpeciesId.CORSOLA, SpeciesId.WAILMER, SpeciesId.CLAMPERL, SpeciesId.LUVDISC, SpeciesId.MANTYKE, SpeciesId.ALOMOMOLA, SpeciesId.TATSUGIRI, SpeciesId.VELUZA],
  ...
  [TrainerType.HIKER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.SANDSHREW, SpeciesId.DIGLETT, SpeciesId.GEODUDE, SpeciesId.MACHOP, SpeciesId.ARON, SpeciesId.ROGGENROLA, SpeciesId.DRILBUR, SpeciesId.NACLI],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.ZUBAT, SpeciesId.RHYHORN, SpeciesId.ONIX, SpeciesId.CUBONE, SpeciesId.WOOBAT, SpeciesId.SWINUB, SpeciesId.NOSEPASS, SpeciesId.HIPPOPOTAS, SpeciesId.DWEBBLE, SpeciesId.KLAWF, SpeciesId.TOEDSCOOL],
      [TrainerPoolTier.RARE]: [SpeciesId.TORKOAL, SpeciesId.TRAPINCH, SpeciesId.BARBOACH, SpeciesId.GOLETT, SpeciesId.ALOLA_DIGLETT, SpeciesId.ALOLA_GEODUDE, SpeciesId.GALAR_STUNFISK, SpeciesId.PALDEA_WOOPER],
  ...
  [TrainerType.OFFICER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.VULPIX, SpeciesId.GROWLITHE, SpeciesId.SNUBBULL, SpeciesId.POOCHYENA, SpeciesId.ELECTRIKE, SpeciesId.LILLIPUP, SpeciesId.YAMPER, SpeciesId.FIDOUGH],
  ...
  [TrainerType.PRESCHOOLER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.CATERPIE, SpeciesId.PICHU, SpeciesId.SANDSHREW, SpeciesId.LEDYBA, SpeciesId.BUDEW, SpeciesId.BURMY, SpeciesId.WOOLOO, SpeciesId.PAWMI, SpeciesId.SMOLIV],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.EEVEE, SpeciesId.CLEFFA, SpeciesId.IGGLYBUFF, SpeciesId.SWINUB, SpeciesId.WOOPER, SpeciesId.DRIFLOON, SpeciesId.DEDENNE, SpeciesId.STUFFUL],
  ...
  [TrainerType.PSYCHIC]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.ABRA, SpeciesId.DROWZEE, SpeciesId.RALTS, SpeciesId.SPOINK, SpeciesId.GOTHITA, SpeciesId.SOLOSIS, SpeciesId.BLIPBUG, SpeciesId.ESPURR, SpeciesId.HATENNA],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.MIME_JR, SpeciesId.EXEGGCUTE, SpeciesId.MEDITITE, SpeciesId.NATU, SpeciesId.WOOBAT, SpeciesId.INKAY, SpeciesId.ORANGURU],
      [TrainerPoolTier.RARE]: [SpeciesId.ELGYEM, SpeciesId.SIGILYPH, SpeciesId.BALTOY, SpeciesId.GIRAFARIG, SpeciesId.MEOWSTIC],
  ...
  [TrainerType.RANGER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.PICHU, SpeciesId.GROWLITHE, SpeciesId.PONYTA, SpeciesId.ZIGZAGOON, SpeciesId.SEEDOT, SpeciesId.BIDOOF, SpeciesId.RIOLU, SpeciesId.SEWADDLE, SpeciesId.SKIDDO, SpeciesId.SALANDIT, SpeciesId.YAMPER],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.AZURILL, SpeciesId.TAUROS, SpeciesId.MAREEP, SpeciesId.FARFETCHD, SpeciesId.TEDDIURSA, SpeciesId.SHROOMISH, SpeciesId.ELECTRIKE, SpeciesId.BUDEW, SpeciesId.BUIZEL, SpeciesId.MUDBRAY, SpeciesId.STUFFUL],
      [TrainerPoolTier.RARE]: [SpeciesId.EEVEE, SpeciesId.SCYTHER, SpeciesId.KANGASKHAN, SpeciesId.RALTS, SpeciesId.MUNCHLAX, SpeciesId.ZORUA, SpeciesId.PALDEA_TAUROS, SpeciesId.TINKATINK, SpeciesId.CYCLIZAR, SpeciesId.FLAMIGO],
  ...
  [TrainerType.RICH]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.MEOWTH, SpeciesId.GROWLITHE, SpeciesId.PONYTA, SpeciesId.SKITTY, SpeciesId.ELECTRIKE, SpeciesId.SPOINK, SpeciesId.BUDEW],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.SNUBBULL, SpeciesId.SABLEYE, SpeciesId.CHATOT, SpeciesId.FURFROU, SpeciesId.CARBINK, SpeciesId.SINISTEA, SpeciesId.INDEEDEE],
      [TrainerPoolTier.RARE]: [SpeciesId.FARFETCHD, SpeciesId.SHELLDER, SpeciesId.EEVEE, SpeciesId.MURKROW, SpeciesId.CLAMPERL, SpeciesId.HONEDGE, SpeciesId.GALAR_PONYTA],
  ...
  [TrainerType.RUIN_MANIAC]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.SANDSHREW, SpeciesId.GEODUDE, SpeciesId.ONIX, SpeciesId.NATU, SpeciesId.NOSEPASS, SpeciesId.BALTOY, SpeciesId.SABLEYE, SpeciesId.RELICANTH, SpeciesId.BRONZOR, SpeciesId.DRILBUR],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.OMANYTE, SpeciesId.KABUTO, SpeciesId.LILEEP, SpeciesId.ANORITH, SpeciesId.SOLROCK, SpeciesId.LUNATONE, SpeciesId.SIGILYPH, SpeciesId.YAMASK, SpeciesId.GOLETT, SpeciesId.CUFANT, SpeciesId.STONJOURNER],
      [TrainerPoolTier.RARE]: [SpeciesId.AERODACTYL, SpeciesId.TRAPINCH, SpeciesId.ARON, SpeciesId.CRANIDOS, SpeciesId.SHIELDON, SpeciesId.TIRTOUGA, SpeciesId.ARCHEN, SpeciesId.TYRUNT, SpeciesId.AMAURA, SpeciesId.GALAR_YAMASK],
  ...
  [TrainerType.SCIENTIST]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.MAGNEMITE, SpeciesId.GRIMER, SpeciesId.DROWZEE, SpeciesId.VOLTORB, SpeciesId.KOFFING],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.BALTOY, SpeciesId.BRONZOR, SpeciesId.FERROSEED, SpeciesId.KLINK, SpeciesId.CHARJABUG, SpeciesId.BLIPBUG, SpeciesId.HELIOPTILE],
      [TrainerPoolTier.RARE]: [SpeciesId.ABRA, SpeciesId.DITTO, SpeciesId.PORYGON, SpeciesId.ELEKID, SpeciesId.SOLOSIS, SpeciesId.GALAR_WEEZING],
      [TrainerPoolTier.SUPER_RARE]: [SpeciesId.OMANYTE, SpeciesId.KABUTO, SpeciesId.AERODACTYL, SpeciesId.LILEEP, SpeciesId.ANORITH, SpeciesId.CRANIDOS, SpeciesId.SHIELDON, SpeciesId.TIRTOUGA, SpeciesId.ARCHEN, SpeciesId.ARCTOVISH, SpeciesId.ARCTOZOLT, SpeciesId.DRACOVISH, SpeciesId.DRACOZOLT],
  ...
  [TrainerType.SCUBA_DIVER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.TENTACOOL, SpeciesId.KRABBY, SpeciesId.HORSEA, SpeciesId.STARYU, SpeciesId.CHINCHOU, SpeciesId.REMORAID, SpeciesId.CARVANHA, SpeciesId.WAILMER, SpeciesId.SPHEAL, SpeciesId.CLAMPERL, SpeciesId.SHELLOS, SpeciesId.MANTYKE],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.SHELLDER, SpeciesId.QWILFISH, SpeciesId.CORSOLA, SpeciesId.RELICANTH, SpeciesId.BUIZEL, SpeciesId.FINNEON, SpeciesId.FRILLISH, SpeciesId.BINACLE, SpeciesId.SKRELP, SpeciesId.CLAUNCHER],
      [TrainerPoolTier.RARE]: [SpeciesId.OMANYTE, SpeciesId.KABUTO, SpeciesId.LILEEP, SpeciesId.ANORITH, SpeciesId.LUVDISC, SpeciesId.TIRTOUGA, SpeciesId.FINIZEN, SpeciesId.HISUI_QWILFISH],
      [TrainerPoolTier.SUPER_RARE]: [SpeciesId.BASCULIN, SpeciesId.WISHIWASHI, SpeciesId.WIMPOD, SpeciesId.DHELMISE, SpeciesId.GALAR_CORSOLA],
    }),
  ...
  [TrainerType.SCHOOL_KID]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.ODDISH, SpeciesId.EXEGGCUTE, SpeciesId.TEDDIURSA, SpeciesId.WURMPLE, SpeciesId.RALTS, SpeciesId.SHROOMISH, SpeciesId.FLETCHLING],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.VOLTORB, SpeciesId.WHISMUR, SpeciesId.MEDITITE, SpeciesId.MIME_JR, SpeciesId.NYMBLE],
  ...
  [TrainerType.WAITER]:  new TrainerConfig(++t)
    ...
    .setEncounterBgm(TrainerType.CLERK)
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.CLEFFA, SpeciesId.CHATOT, SpeciesId.PANSAGE, SpeciesId.PANSEAR, SpeciesId.PANPOUR, SpeciesId.MINCCINO],
  ...
  [TrainerType.YOUNGSTER]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.CATERPIE, SpeciesId.WEEDLE, SpeciesId.RATTATA, SpeciesId.SENTRET, SpeciesId.POOCHYENA, SpeciesId.ZIGZAGOON, SpeciesId.WURMPLE, SpeciesId.BIDOOF, SpeciesId.PATRAT, SpeciesId.LILLIPUP],
    }),
  [TrainerType.ROCKET_GRUNT]:  new TrainerConfig(++t)
    ...
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.WEEDLE, SpeciesId.RATTATA, SpeciesId.EKANS, SpeciesId.SANDSHREW, SpeciesId.ZUBAT, SpeciesId.ODDISH, SpeciesId.GEODUDE, SpeciesId.SLOWPOKE, SpeciesId.GRIMER, SpeciesId.KOFFING],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.MANKEY, SpeciesId.GROWLITHE, SpeciesId.MAGNEMITE, SpeciesId.ONIX, SpeciesId.VOLTORB, SpeciesId.EXEGGCUTE, SpeciesId.CUBONE, SpeciesId.LICKITUNG, SpeciesId.TAUROS, SpeciesId.MURKROW],
      [TrainerPoolTier.RARE]: [SpeciesId.MAGIKARP, SpeciesId.ABRA, SpeciesId.GASTLY, SpeciesId.SCYTHER, SpeciesId.PORYGON, SpeciesId.OMANYTE, SpeciesId.KABUTO, SpeciesId.ELEKID, SpeciesId.MAGBY, SpeciesId.ALOLA_RATTATA, SpeciesId.ALOLA_SANDSHREW, SpeciesId.ALOLA_MEOWTH, SpeciesId.ALOLA_GEODUDE, SpeciesId.ALOLA_GRIMER, SpeciesId.PALDEA_TAUROS],
  ...
  [TrainerType.MAGMA_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.DIGLETT, SpeciesId.KOFFING, SpeciesId.SLUGMA, SpeciesId.POOCHYENA, SpeciesId.ZIGZAGOON, SpeciesId.TORKOAL, SpeciesId.BALTOY],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.PHANPY, SpeciesId.MAGBY, SpeciesId.ZANGOOSE, SpeciesId.NUMEL, SpeciesId.SOLROCK, SpeciesId.HEATMOR, SpeciesId.ROLYCOLY, SpeciesId.SIZZLIPEDE],
      [TrainerPoolTier.RARE]: [SpeciesId.TRAPINCH, SpeciesId.LILEEP, SpeciesId.ANORITH, SpeciesId.TURTONATOR, SpeciesId.TOEDSCOOL, SpeciesId.CAPSAKID],
  ...
  [TrainerType.AQUA_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.TENTACOOL, SpeciesId.QWILFISH, SpeciesId.REMORAID, SpeciesId.ZIGZAGOON, SpeciesId.POOCHYENA, SpeciesId.LOTAD, SpeciesId.WINGULL, SpeciesId.BARBOACH, SpeciesId.CORPHISH],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.HORSEA, SpeciesId.CHINCHOU, SpeciesId.WOOPER, SpeciesId.AZURILL, SpeciesId.SEVIPER, SpeciesId.CARVANHA, SpeciesId.WAILMER, SpeciesId.CLAMPERL, SpeciesId.SPHEAL],
      [TrainerPoolTier.RARE]: [SpeciesId.MANTYKE, SpeciesId.TYMPOLE, SpeciesId.SKRELP, SpeciesId.WIMPOD, SpeciesId.CLOBBOPUS, SpeciesId.ARROKUDA, SpeciesId.WIGLETT],
  ...
  [TrainerType.GALACTIC_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.WURMPLE, SpeciesId.SHINX, SpeciesId.BURMY, SpeciesId.DRIFLOON, SpeciesId.GLAMEOW, SpeciesId.STUNKY, SpeciesId.BRONZOR, SpeciesId.CROAGUNK, SpeciesId.CARNIVINE],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.ZUBAT, SpeciesId.LICKITUNG, SpeciesId.RHYHORN, SpeciesId.TANGELA, SpeciesId.YANMA, SpeciesId.GLIGAR, SpeciesId.SHELLOS, SpeciesId.SKORUPI],
      [TrainerPoolTier.RARE]: [SpeciesId.SNEASEL, SpeciesId.TEDDIURSA, SpeciesId.ELEKID, SpeciesId.MAGBY, SpeciesId.SWINUB, SpeciesId.DUSKULL],
  ...
  [TrainerType.PLASMA_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.PATRAT, SpeciesId.LILLIPUP, SpeciesId.PURRLOIN, SpeciesId.WOOBAT, SpeciesId.TYMPOLE, SpeciesId.SANDILE, SpeciesId.SCRAGGY, SpeciesId.TRUBBISH, SpeciesId.VANILLITE],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.TIMBURR, SpeciesId.VENIPEDE, SpeciesId.DARUMAKA, SpeciesId.FOONGUS, SpeciesId.FRILLISH, SpeciesId.JOLTIK, SpeciesId.KLINK, SpeciesId.CUBCHOO, SpeciesId.GOLETT],
      [TrainerPoolTier.RARE]: [SpeciesId.DRILBUR, SpeciesId.ZORUA, SpeciesId.MIENFOO, SpeciesId.PAWNIARD, SpeciesId.BOUFFALANT, SpeciesId.RUFFLET, SpeciesId.VULLABY, SpeciesId.DURANT],
  ...
  [TrainerType.FLARE_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.ZUBAT, SpeciesId.POOCHYENA, SpeciesId.GULPIN, SpeciesId.CROAGUNK, SpeciesId.PURRLOIN, SpeciesId.FOONGUS, SpeciesId.SCRAGGY, SpeciesId.BUNNELBY, SpeciesId.FLETCHLING, SpeciesId.SCATTERBUG, SpeciesId.PANCHAM, SpeciesId.ESPURR, SpeciesId.HELIOPTILE, SpeciesId.INKAY],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.HOUNDOUR, SpeciesId.ELECTRIKE, SpeciesId.SABLEYE, SpeciesId.SKORUPI, SpeciesId.VENIPEDE, SpeciesId.LITLEO, SpeciesId.BINACLE, SpeciesId.SKRELP, SpeciesId.CLAUNCHER, SpeciesId.PHANTUMP, SpeciesId.PUMPKABOO, SpeciesId.NICKIT, SpeciesId.ALOLA_MEOWTH],
  ...
  [TrainerType.AETHER_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.CORSOLA, SpeciesId.LILLIPUP, SpeciesId.PIKIPEK, SpeciesId.YUNGOOS, SpeciesId.ROCKRUFF, SpeciesId.MORELULL, SpeciesId.BOUNSWEET, SpeciesId.COMFEY, SpeciesId.KOMALA, SpeciesId.TOGEDEMARU, SpeciesId.ALOLA_RAICHU, SpeciesId.ALOLA_DIGLETT, SpeciesId.ALOLA_GEODUDE, SpeciesId.ALOLA_EXEGGUTOR],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.POLIWAG, SpeciesId.CRABRAWLER, SpeciesId.ORICORIO, SpeciesId.CUTIEFLY, SpeciesId.WISHIWASHI, SpeciesId.MUDBRAY, SpeciesId.STUFFUL, SpeciesId.ORANGURU, SpeciesId.PASSIMIAN, SpeciesId.PYUKUMUKU, SpeciesId.BRUXISH, SpeciesId.ALOLA_SANDSHREW, SpeciesId.ALOLA_VULPIX, SpeciesId.ALOLA_MAROWAK],
      [TrainerPoolTier.RARE]: [SpeciesId.MINIOR, SpeciesId.TURTONATOR, SpeciesId.MIMIKYU, SpeciesId.DRAMPA, SpeciesId.GALAR_CORSOLA],
  ...
  [TrainerType.SKULL_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.EKANS, SpeciesId.VENONAT, SpeciesId.DROWZEE, SpeciesId.KOFFING, SpeciesId.SPINARAK, SpeciesId.SCRAGGY, SpeciesId.TRUBBISH, SpeciesId.MAREANIE, SpeciesId.SALANDIT, SpeciesId.ALOLA_RATTATA, SpeciesId.ALOLA_MEOWTH, SpeciesId.ALOLA_GRIMER],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.ZUBAT, SpeciesId.GASTLY, SpeciesId.HOUNDOUR, SpeciesId.SABLEYE, SpeciesId.VENIPEDE, SpeciesId.SANDILE, SpeciesId.VULLABY, SpeciesId.PANCHAM, SpeciesId.FOMANTIS, SpeciesId.ALOLA_MAROWAK],
      [TrainerPoolTier.RARE]: [SpeciesId.DEWPIDER, SpeciesId.WISHIWASHI, SpeciesId.SANDYGAST, SpeciesId.MIMIKYU, SpeciesId.DHELMISE, SpeciesId.NYMBLE],
  ...
  [TrainerType.MACRO_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.STEELIX, SpeciesId.MAWILE, SpeciesId.FERROSEED, SpeciesId.KLINK, SpeciesId.SKWOVET, SpeciesId.ROOKIDEE, SpeciesId.ROLYCOLY, SpeciesId.CUFANT, SpeciesId.GALAR_MEOWTH, SpeciesId.GALAR_ZIGZAGOON],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.MAGNEMITE, SpeciesId.RIOLU, SpeciesId.DRILBUR, SpeciesId.APPLIN, SpeciesId.CRAMORANT, SpeciesId.ARROKUDA, SpeciesId.SINISTEA, SpeciesId.HATENNA, SpeciesId.FALINKS, SpeciesId.GALAR_PONYTA, SpeciesId.GALAR_YAMASK],
      [TrainerPoolTier.RARE]: [SpeciesId.SCIZOR, SpeciesId.BELDUM, SpeciesId.HONEDGE, SpeciesId.GALAR_FARFETCHD, SpeciesId.GALAR_MR_MIME, SpeciesId.GALAR_DARUMAKA],
  ...
  [TrainerType.STAR_GRUNT]:  new TrainerConfig(++t)
    ...
    .setPartyTemplateFunc(() => getEvilGruntPartyTemplate())
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [SpeciesId.DUNSPARCE, SpeciesId.HOUNDOUR, SpeciesId.AZURILL, SpeciesId.GULPIN, SpeciesId.FOONGUS, SpeciesId.FLETCHLING, SpeciesId.LITLEO, SpeciesId.FLABEBE, SpeciesId.CRABRAWLER, SpeciesId.NYMBLE, SpeciesId.PAWMI, SpeciesId.FIDOUGH, SpeciesId.SQUAWKABILLY, SpeciesId.MASCHIFF, SpeciesId.SHROODLE, SpeciesId.KLAWF, SpeciesId.WIGLETT, SpeciesId.PALDEA_WOOPER],
      [TrainerPoolTier.UNCOMMON]: [SpeciesId.KOFFING, SpeciesId.EEVEE, SpeciesId.GIRAFARIG, SpeciesId.RALTS, SpeciesId.TORKOAL, SpeciesId.SEVIPER, SpeciesId.SCRAGGY, SpeciesId.ZORUA, SpeciesId.MIMIKYU, SpeciesId.IMPIDIMP, SpeciesId.FALINKS, SpeciesId.CAPSAKID, SpeciesId.TINKATINK, SpeciesId.BOMBIRDIER, SpeciesId.CYCLIZAR, SpeciesId.FLAMIGO, SpeciesId.PALDEA_TAUROS],
      [TrainerPoolTier.RARE]: [SpeciesId.MANKEY, SpeciesId.PAWNIARD, SpeciesId.CHARCADET, SpeciesId.FLITTLE, SpeciesId.VAROOM, SpeciesId.ORTHWORM],
