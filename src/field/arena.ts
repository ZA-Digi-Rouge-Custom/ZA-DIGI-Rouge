...
export class Arena {
  ...
  public randomSpecies(waveIndex: number, level: number, attempt = 0, luckValue = 0, isBoss?: boolean): PokemonSpecies {
    ...
    const newSpeciesId = species.getWildSpeciesForLevel(level, globalScene.currentBattle.battleSpec !== BattleSpec.FINAL_BOSS, isBoss ?? isBossSpecies, globalScene.gameMode);
