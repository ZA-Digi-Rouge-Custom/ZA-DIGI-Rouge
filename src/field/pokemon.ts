...
export abstract class Pokemon extends Phaser.GameObjects.Container {
  ...
  getEffectiveStat(
    ...
    const ignoreWeatherDefBoost = opponent?.hasAbility(AbilityId.MEGA_SOL) ?? false;
  ...
  public isGrounded(): boolean {
    return (
      ...
      || (!this.isOfType(PokemonType.FLYING, true, true)
        ...
        && !this.hasAbility(AbilityId.EELEVATE)
...
export class EnemyPokemon extends Pokemon {
  ...
  override generateAndPopulateMoveset(useRivalSignatures = false, formIndex?: number): void {
    switch (true) {
      ...
      case this.species.speciesId === SpeciesId.ABOMASNOW:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.INGRAIN),
              new PokemonMove(MoveId.WOOD_HAMMER),
              new PokemonMove(MoveId.BLIZZARD),
              new PokemonMove(MoveId.SHEER_COLD),
            ]
          : [
              new PokemonMove(MoveId.INGRAIN),
              new PokemonMove(MoveId.WOOD_HAMMER),
        ...
        break;
case this.species.speciesId === SpeciesId.ABSOL:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SUCKER_PUNCH),
              new PokemonMove(MoveId.SWORDS_DANCE),
              new PokemonMove(MoveId.FUTURE_SIGHT),
        ...
        break;
case this.species.speciesId === SpeciesId.AEGISLASH:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HEAD_SMASH),
              new PokemonMove(MoveId.AUTOTOMIZE),
              new PokemonMove(MoveId.RETALIATE),
              new PokemonMove(MoveId.SACRED_SWORD),
            ]
          : [
              new PokemonMove(MoveId.HEAD_SMASH),
              new PokemonMove(MoveId.AUTOTOMIZE),
        ...
        break;
case this.species.speciesId === SpeciesId.AERODACTYL:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.STONE_EDGE),
              new PokemonMove(MoveId.AGILITY),
              new PokemonMove(MoveId.HYPER_BEAM),
              new PokemonMove(MoveId.GIGA_IMPACT),
            ]
          : [
              new PokemonMove(MoveId.STONE_EDGE),
              new PokemonMove(MoveId.AGILITY),
        ...
        break;
case this.species.speciesId === SpeciesId.AGGRON:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.HEAVY_SLAM),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.METAL_BURST),
            ]
          : [
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.HEAVY_SLAM),
        ...
        break;
case this.species.speciesId === SpeciesId.ALAKAZAM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.ROLE_PLAY),
              new PokemonMove(MoveId.FUTURE_SIGHT),
...
case this.species.speciesId === SpeciesId.ALCREMIE:
        ...
        break;
case this.species.speciesId === SpeciesId.ALTARIA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.TAKE_DOWN),
              new PokemonMove(MoveId.MOONBLAST),
              new PokemonMove(MoveId.PERISH_SONG),
              new PokemonMove(MoveId.SKY_ATTACK),
            ]
          : [
              new PokemonMove(MoveId.TAKE_DOWN),
              new PokemonMove(MoveId.MOONBLAST),
        ...
        break;
case this.species.speciesId === SpeciesId.AMPHAROS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.COTTON_GUARD),
              new PokemonMove(MoveId.DAZZLING_GLEAM),
              new PokemonMove(MoveId.LIGHT_SCREEN),
              new PokemonMove(MoveId.THUNDER),
            ]
          : [
              new PokemonMove(MoveId.COTTON_GUARD),
              new PokemonMove(MoveId.DAZZLING_GLEAM),
        ...
        break;
case this.species.speciesId === SpeciesId.APPLETUN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.BODY_SLAM),
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.DRAGON_PULSE),
              new PokemonMove(MoveId.ENERGY_BALL),
            ]
          : [
              new PokemonMove(MoveId.BODY_SLAM),
              new PokemonMove(MoveId.IRON_DEFENSE),
...
case this.species.speciesId === SpeciesId.ARCEUS:
        ...
        break;
case this.species.speciesId === SpeciesId.AUDINO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.ENTRAINMENT),
              new PokemonMove(MoveId.MISTY_TERRAIN),
              new PokemonMove(MoveId.LAST_RESORT),
            ]
          : [
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.ENTRAINMENT),
        ...
        break;
case this.species.speciesId === SpeciesId.BANETTE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ROLE_PLAY),
              new PokemonMove(MoveId.SUCKER_PUNCH),
              new PokemonMove(MoveId.TRICK),
              new PokemonMove(MoveId.PHANTOM_FORCE),
            ]
          : [
              new PokemonMove(MoveId.ROLE_PLAY),
              new PokemonMove(MoveId.SUCKER_PUNCH),
        ...
        break;
case this.species.speciesId === SpeciesId.BASCULEGION:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.HEAD_SMASH),
              new PokemonMove(MoveId.FINAL_GAMBIT),
            ]
          : [
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.DOUBLE_EDGE),
        ...
        break;
case this.species.speciesId === SpeciesId.BASCULIN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.WAVE_CRASH),
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.HEAD_SMASH),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.BEEDRILL:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.POISON_JAB),
              new PokemonMove(MoveId.AGILITY),
              new PokemonMove(MoveId.ENDEAVOR),
              new PokemonMove(MoveId.FELL_STINGER),
            ]
          : [
              new PokemonMove(MoveId.POISON_JAB),
              new PokemonMove(MoveId.AGILITY),
        ...
        break;
case this.species.speciesId === SpeciesId.BLASTOISE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SHELL_SMASH),
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.HYDRO_PUMP),
              new PokemonMove(MoveId.WAVE_CRASH),
            ]
          : [
              new PokemonMove(MoveId.SHELL_SMASH),
        ...
        break;
case this.species.speciesId === SpeciesId.BLAZIKEN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FIRE_PUNCH),
              new PokemonMove(MoveId.EMBER),
              new PokemonMove(MoveId.FLAMETHROWER),
              new PokemonMove(MoveId.FEATHER_DANCE),
            ]
          : [
              new PokemonMove(MoveId.FIRE_PUNCH),
              new PokemonMove(MoveId.EMBER),
        ...
        break;
case this.species.speciesId === SpeciesId.BUTTERFREE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.BUG_BUZZ),
              new PokemonMove(MoveId.TAILWIND),
              new PokemonMove(MoveId.RAGE_POWDER),
              new PokemonMove(MoveId.QUIVER_DANCE),
            ]
          : [
              new PokemonMove(MoveId.BUG_BUZZ),
              new PokemonMove(MoveId.TAILWIND),
        ...
        break;
case this.species.speciesId === SpeciesId.CALYREX:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.LEECH_SEED),
              new PokemonMove(MoveId.HEAL_PULSE),
              new PokemonMove(MoveId.SOLAR_BEAM),
              new PokemonMove(MoveId.FUTURE_SIGHT),
            ]
          : [
              new PokemonMove(MoveId.LEECH_SEED),
        ...
        break;
case this.species.speciesId === SpeciesId.CAMERUPT:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.YAWN),
        ...
        break;
case this.species.speciesId === SpeciesId.CASTFORM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HYDRO_PUMP),
              new PokemonMove(MoveId.FIRE_BLAST),
              new PokemonMove(MoveId.BLIZZARD),
              new PokemonMove(MoveId.HURRICANE),
            ]
          : [
              new PokemonMove(MoveId.HYDRO_PUMP),
              new PokemonMove(MoveId.FIRE_BLAST),
        ...
        break;
case this.species.speciesId === SpeciesId.CENTISKORCH:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.FIRE_LASH),
              new PokemonMove(MoveId.LUNGE),
              new PokemonMove(MoveId.BURN_UP),
            ]
          : [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.FIRE_LASH),
        ...
        break;
case this.species.speciesId === SpeciesId.CHARIZARD:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SCARY_FACE),
              new PokemonMove(MoveId.FIRE_SPIN),
              new PokemonMove(MoveId.INFERNO),
              new PokemonMove(MoveId.FLARE_BLITZ),
            ]
          : [
              new PokemonMove(MoveId.SCARY_FACE),
              new PokemonMove(MoveId.FIRE_SPIN),
        ...
        break;
case this.species.speciesId === SpeciesId.CHERRIM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.PETAL_BLIZZARD),
              new PokemonMove(MoveId.WORRY_SEED),
              new PokemonMove(MoveId.SOLAR_BEAM),
              new PokemonMove(MoveId.PETAL_DANCE),
            ]
          : [
              new PokemonMove(MoveId.PETAL_BLIZZARD),
              new PokemonMove(MoveId.WORRY_SEED),
        ...
        break;
case this.species.speciesId === SpeciesId.CINDERACE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.COUNTER),
              new PokemonMove(MoveId.BOUNCE),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.COURT_CHANGE),
            ]
          : [
              new PokemonMove(MoveId.COUNTER),
              new PokemonMove(MoveId.BOUNCE),
        ...
        break;
case this.species.speciesId === SpeciesId.COALOSSAL:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.STEALTH_ROCK),
              new PokemonMove(MoveId.HEAT_CRASH),
              new PokemonMove(MoveId.ROCK_BLAST),
              new PokemonMove(MoveId.STONE_EDGE),
            ]
          : [
              new PokemonMove(MoveId.STEALTH_ROCK),
        ...
        break;
case this.species.speciesId === SpeciesId.COPPERAJAH:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.IRON_HEAD),
              new PokemonMove(MoveId.PLAY_ROUGH),
              new PokemonMove(MoveId.HIGH_HORSEPOWER),
              new PokemonMove(MoveId.SUPERPOWER),
            ]
          : [
              new PokemonMove(MoveId.IRON_HEAD),
              new PokemonMove(MoveId.PLAY_ROUGH),
        ...
        break;
case this.species.speciesId === SpeciesId.CORVIKNIGHT:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SCARY_FACE),
              new PokemonMove(MoveId.DRILL_PECK),
              new PokemonMove(MoveId.SWAGGER),
              new PokemonMove(MoveId.BRAVE_BIRD),
            ]
          : [
              new PokemonMove(MoveId.SCARY_FACE),
              new PokemonMove(MoveId.DRILL_PECK),
        ...
        break;
case this.species.speciesId === SpeciesId.CRABOMINABLE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.DYNAMIC_PUNCH),
              new PokemonMove(MoveId.CLOSE_COMBAT),
              new PokemonMove(MoveId.CRABHAMMER),
            ]
          : [
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.DYNAMIC_PUNCH),
        ...
        break;
case this.species.speciesId === SpeciesId.CRAMORANT:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.AMNESIA),
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.HYDRO_PUMP),
              new PokemonMove(MoveId.BELCH),
            ]
          : [
              new PokemonMove(MoveId.AMNESIA),
              new PokemonMove(MoveId.THRASH),
        ...
        break;
case this.species.speciesId === SpeciesId.DARMANITAN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.BELLY_DRUM),
              new PokemonMove(MoveId.FLARE_BLITZ),
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.SUPERPOWER),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.DARKRAI:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DARK_VOID),
              new PokemonMove(MoveId.MOONBLAST),
              new PokemonMove(MoveId.FIERY_DANCE),
              new PokemonMove(MoveId.AURA_SPHERE),
            ]
          : [
              new PokemonMove(MoveId.DARK_VOID),
              new PokemonMove(MoveId.DARK_PULSE),
              new PokemonMove(MoveId.MOONBLAST),
              new PokemonMove(MoveId.FIERY_DANCE),
            ];
        if (globalScene.gameMode.hasChallenge(Challenges.INVERSE_BATTLE)) {
        ...
        break;
case this.species.speciesId === SpeciesId.DEOXYS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.COSMIC_POWER),
              new PokemonMove(MoveId.ZAP_CANNON),
              new PokemonMove(MoveId.PSYCHO_BOOST),
              new PokemonMove(MoveId.HYPER_BEAM),
            ]
          : [
              new PokemonMove(MoveId.COSMIC_POWER),
        ...
        break;
case this.species.speciesId === SpeciesId.DIALGA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.METAL_BURST),
              new PokemonMove(MoveId.EARTH_POWER),
              new PokemonMove(MoveId.IRON_TAIL),
              new PokemonMove(MoveId.ROAR_OF_TIME),
            ]
          : [
              new PokemonMove(MoveId.METAL_BURST),
              new PokemonMove(MoveId.EARTH_POWER),
        ...
        break;
case this.species.speciesId === SpeciesId.DIANCIE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.POWER_GEM),
              new PokemonMove(MoveId.STEALTH_ROCK),
              new PokemonMove(MoveId.MOONBLAST),
              new PokemonMove(MoveId.STONE_EDGE),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.DRAGONITE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FLAMETHROWER),
              new PokemonMove(MoveId.DYNAMAX_CANNON),
              new PokemonMove(MoveId.THUNDERBOLT),
              new PokemonMove(MoveId.OBLIVION_WING),
            ]
          : [
              new PokemonMove(MoveId.DRAGON_DANCE),
              new PokemonMove(MoveId.SCALE_SHOT),
              new PokemonMove(MoveId.AGILITY),
              new PokemonMove(MoveId.FIRE_LASH),
            ];
        if (globalScene.gameMode.hasChallenge(Challenges.INVERSE_BATTLE)) {
        ...
        break;
case this.species.speciesId === SpeciesId.DREDNAW:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.JAW_LOCK),
              new PokemonMove(MoveId.LIQUIDATION),
              new PokemonMove(MoveId.BODY_SLAM),
              new PokemonMove(MoveId.HEAD_SMASH),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.DUDUNSPARCE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.ENDEAVOR),
              new PokemonMove(MoveId.HURRICANE),
              new PokemonMove(MoveId.BOOMBURST),
            ]
          : [
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.ENDEAVOR),
        ...
        break;
case this.species.speciesId === SpeciesId.DURALUDON:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DRAGON_CLAW),
              new PokemonMove(MoveId.FLASH_CANNON),
              new PokemonMove(MoveId.METAL_BURST),
              new PokemonMove(MoveId.HYPER_BEAM),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.EEVEE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CHARM),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.SPARKLY_SWIRL),
              new PokemonMove(MoveId.LAST_RESORT),
            ]
          : [
              new PokemonMove(MoveId.CHARM),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.LAST_RESORT),
              new PokemonMove(MoveId.VEEVEE_VOLLEY),
            ];
        if (globalScene.gameMode.hasChallenge(Challenges.INVERSE_BATTLE)) {
          this.moveset[2] = new PokemonMove(MoveId.THUNDERBOLT);
        }
        break;
case this.species.speciesId === SpeciesId.EISCUE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SNOWSCAPE),
              new PokemonMove(MoveId.AURORA_VEIL),
              new PokemonMove(MoveId.SURF),
              new PokemonMove(MoveId.BLIZZARD),
            ]
          : [
              new PokemonMove(MoveId.SNOWSCAPE),
        ...
        break;
case this.species.speciesId === SpeciesId.ENAMORUS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HEALING_WISH),
              new PokemonMove(MoveId.MOONBLAST),
              new PokemonMove(MoveId.OUTRAGE),
              new PokemonMove(MoveId.SPRINGTIDE_STORM),
            ]
          : [
              new PokemonMove(MoveId.HEALING_WISH),
              new PokemonMove(MoveId.MOONBLAST),
...
case this.species.speciesId === SpeciesId.ETERNATUS:
        ...
        break;
case this.species.speciesId === SpeciesId.FLAPPLE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.GRAV_APPLE),
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.FLY),
              new PokemonMove(MoveId.DRAGON_RUSH),
            ]
          : [
              new PokemonMove(MoveId.GRAV_APPLE),
              new PokemonMove(MoveId.IRON_DEFENSE),
        ...
        break;
case this.species.speciesId === SpeciesId.FLORGES:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DISARMING_VOICE),
              new PokemonMove(MoveId.GRASSY_TERRAIN),
              new PokemonMove(MoveId.MISTY_TERRAIN),
              new PokemonMove(MoveId.MOONBLAST),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.FURFROU:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.TAKE_DOWN),
              new PokemonMove(MoveId.CHARM),
        ...
        break;
case this.species.speciesId === SpeciesId.GALAR_DARMANITAN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.BELLY_DRUM),
              new PokemonMove(MoveId.BLIZZARD),
        ...
        break;
case this.species.speciesId === SpeciesId.GALLADE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HEAL_PULSE),
              new PokemonMove(MoveId.WIDE_GUARD),
              new PokemonMove(MoveId.QUICK_GUARD),
              new PokemonMove(MoveId.CLOSE_COMBAT),
            ]
          : [
              new PokemonMove(MoveId.HEAL_PULSE),
        ...
        break;
case this.species.speciesId === SpeciesId.GARBODOR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.BELCH),
              new PokemonMove(MoveId.PAIN_SPLIT),
              new PokemonMove(MoveId.GUNK_SHOT),
              new PokemonMove(MoveId.EXPLOSION),
            ]
          : [
              new PokemonMove(MoveId.BELCH),
              new PokemonMove(MoveId.PAIN_SPLIT),
        ...
        break;
case this.species.speciesId === SpeciesId.GARCHOMP:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DIG),
              new PokemonMove(MoveId.SANDSTORM),
              new PokemonMove(MoveId.TAKE_DOWN),
              new PokemonMove(MoveId.DRAGON_RUSH),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.GARDEVOIR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.MOONBLAST),
              new PokemonMove(MoveId.DREAM_EATER),
              new PokemonMove(MoveId.FUTURE_SIGHT),
            ]
          : [
              new PokemonMove(MoveId.PSYCHIC),
        ...
        break;
case this.species.speciesId === SpeciesId.GASTRODON:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.MUDDY_WATER),
              new PokemonMove(MoveId.EARTH_POWER),
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.MEMENTO),
            ]
          : [
              new PokemonMove(MoveId.MUDDY_WATER),
              new PokemonMove(MoveId.EARTH_POWER),
        ...
        break;
case this.species.speciesId === SpeciesId.GENESECT:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ZAP_CANNON),
              new PokemonMove(MoveId.LOCK_ON),
              new PokemonMove(MoveId.TECHNO_BLAST),
              new PokemonMove(MoveId.SELF_DESTRUCT),
            ]
          : [
              new PokemonMove(MoveId.ZAP_CANNON),
              new PokemonMove(MoveId.LOCK_ON),
        ...
        break;
case this.species.speciesId === SpeciesId.GENGAR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DARK_PULSE),
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.DESTINY_BOND),
              new PokemonMove(MoveId.DREAM_EATER),
            ]
          : [
              new PokemonMove(MoveId.DARK_PULSE),
        ...
        break;
case this.species.speciesId === SpeciesId.GIMMIGHOUL:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.TACKLE),
              new PokemonMove(MoveId.ASTONISH),
            ]
          : [
              new PokemonMove(MoveId.TACKLE),
              new PokemonMove(MoveId.ASTONISH),
        ...
        break;
case this.species.speciesId === SpeciesId.GIRATINA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DRAGON_CLAW),
              new PokemonMove(MoveId.EARTH_POWER),
              new PokemonMove(MoveId.SHADOW_FORCE),
              new PokemonMove(MoveId.DESTINY_BOND),
            ]
          : [
              new PokemonMove(MoveId.DRAGON_CLAW),
        ...
        break;
case this.species.speciesId === SpeciesId.GLALIE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SNOWSCAPE),
              new PokemonMove(MoveId.WEATHER_BALL),
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.BLIZZARD),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.GOURGEIST:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.TRICK),
        ...
        break;
case this.species.speciesId === SpeciesId.GRENINJA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SUBSTITUTE),
              new PokemonMove(MoveId.EXTRASENSORY),
              new PokemonMove(MoveId.DOUBLE_TEAM),
              new PokemonMove(MoveId.HYDRO_PUMP),
            ]
          : [
              new PokemonMove(MoveId.SUBSTITUTE),
        ...
        break;
case this.species.speciesId === SpeciesId.GRIMMSNARL:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.NASTY_PLOT),
              new PokemonMove(MoveId.PLAY_ROUGH),
              new PokemonMove(MoveId.FOUL_PLAY),
        ...
        break;
case this.species.speciesId === SpeciesId.GROUDON:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.REST),
              new PokemonMove(MoveId.FIRE_BLAST),
              new PokemonMove(MoveId.SOLAR_BEAM),
              new PokemonMove(MoveId.ERUPTION),
            ]
          : [
              new PokemonMove(MoveId.REST),
              new PokemonMove(MoveId.FIRE_BLAST),
        ...
        break;
case this.species.speciesId === SpeciesId.GYARADOS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HYDRO_PUMP),
              new PokemonMove(MoveId.HURRICANE),
        ...
        break;
case this.species.speciesId === SpeciesId.HATTERENE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CALM_MIND),
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.HEALING_WISH),
              new PokemonMove(MoveId.MAGIC_POWDER),
            ]
          : [
              new PokemonMove(MoveId.CALM_MIND),
              new PokemonMove(MoveId.PSYCHIC),
        ...
        break;
case this.species.speciesId === SpeciesId.HEATRAN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ERUPTION),
              new PokemonMove(MoveId.FLASH_CANNON),
          ...
          : [
              new PokemonMove(MoveId.TORCH_SONG),
              new PokemonMove(MoveId.FLASH_CANNON),
              new PokemonMove(MoveId.EARTH_POWER),
              new PokemonMove(MoveId.RECOVER),
            ];
        ...
        break;
case this.species.speciesId === SpeciesId.HERACROSS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.SWORDS_DANCE),
              new PokemonMove(MoveId.MEGAHORN),
              new PokemonMove(MoveId.CLOSE_COMBAT),
            ]
          : [
              new PokemonMove(MoveId.THRASH),
        ...
        break;
case this.species.speciesId === SpeciesId.HOOPA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.WONDER_ROOM),
              new PokemonMove(MoveId.DARK_PULSE),
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.HYPERSPACE_FURY),
            ]
          : [
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.NASTY_PLOT),
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.HYPERSPACE_HOLE),
            ];
        if (globalScene.gameMode.hasChallenge(Challenges.INVERSE_BATTLE)) {
          this.moveset[2] = new PokemonMove(MoveId.THUNDERBOLT);
        }
        break;
case this.species.speciesId === SpeciesId.HOUNDOOM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FOUL_PLAY),
              new PokemonMove(MoveId.FLAMETHROWER),
        ...
        break;
case this.species.speciesId === SpeciesId.INDEEDEE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.CALM_MIND),
              new PokemonMove(MoveId.GUARD_SPLIT),
              new PokemonMove(MoveId.PSYCHIC_TERRAIN),
            ]
          : [
              new PokemonMove(MoveId.CALM_MIND),
              new PokemonMove(MoveId.POWER_SPLIT),
              new PokemonMove(MoveId.PSYCHIC_TERRAIN),
              new PokemonMove(MoveId.LAST_RESORT),
            ];
        if (globalScene.gameMode.hasChallenge(Challenges.INVERSE_BATTLE)) {
        ...
        break;
case this.species.speciesId === SpeciesId.INTELEON:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.LIQUIDATION),
              new PokemonMove(MoveId.SOAK),
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.HYDRO_PUMP),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.KANGASKHAN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ENDURE),
              new PokemonMove(MoveId.REVERSAL),
              new PokemonMove(MoveId.OUTRAGE),
              new PokemonMove(MoveId.LAST_RESORT),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.KELDEO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SACRED_SWORD),
              new PokemonMove(MoveId.SWORDS_DANCE),
        ...
        break;
case this.species.speciesId === SpeciesId.KINGLER:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SLAM),
              new PokemonMove(MoveId.SWORDS_DANCE),
              new PokemonMove(MoveId.CRABHAMMER),
              new PokemonMove(MoveId.GUILLOTINE),
            ]
          : [
              new PokemonMove(MoveId.SLAM),
              new PokemonMove(MoveId.SWORDS_DANCE),
        ...
        break;
case this.species.speciesId === SpeciesId.KYOGRE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.AQUA_RING),
              new PokemonMove(MoveId.HYDRO_PUMP),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.WATER_SPOUT),
            ]
          : [
              new PokemonMove(MoveId.AQUA_RING),
              new PokemonMove(MoveId.HYDRO_PUMP),
        ...
        break;
case this.species.speciesId === SpeciesId.KYUREM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.IMPRISON),
              new PokemonMove(MoveId.OUTRAGE),
              new PokemonMove(MoveId.FREEZE_SHOCK),
              new PokemonMove(MoveId.SHEER_COLD),
            ]
          : [
              new PokemonMove(MoveId.IMPRISON),
              new PokemonMove(MoveId.OUTRAGE),
              new PokemonMove(MoveId.GLACIATE),
              new PokemonMove(MoveId.SHEER_COLD),
            ];
        if (globalScene.gameMode.hasChallenge(Challenges.INVERSE_BATTLE)) {
          this.moveset[2] = new PokemonMove(MoveId.THUNDERBOLT);
        ...
        break;
case this.species.speciesId === SpeciesId.LANDORUS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.EARTHQUAKE),
              new PokemonMove(MoveId.OUTRAGE),
              new PokemonMove(MoveId.FISSURE),
              new PokemonMove(MoveId.SANDSEAR_STORM),
            ]
          : [
              new PokemonMove(MoveId.EARTHQUAKE),
              new PokemonMove(MoveId.OUTRAGE),
        ...
        break;
case this.species.speciesId === SpeciesId.LAPRAS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.HYDRO_PUMP),
        ...
        break;
case this.species.speciesId === SpeciesId.LATIAS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.REFLECT_TYPE),
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.GUARD_SPLIT),
              new PokemonMove(MoveId.HEALING_WISH),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.LATIOS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SIMPLE_BEAM),
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.POWER_SPLIT),
              new PokemonMove(MoveId.MEMENTO),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.LOPUNNY:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FLATTER),
              new PokemonMove(MoveId.BOUNCE),
              new PokemonMove(MoveId.HEALING_WISH),
              new PokemonMove(MoveId.HIGH_JUMP_KICK),
            ]
          : [
              new PokemonMove(MoveId.FLATTER),
              new PokemonMove(MoveId.BOUNCE),
        ...
        break;
case this.species.speciesId === SpeciesId.LUCARIO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.METEOR_MASH),
              new PokemonMove(MoveId.DRAGON_PULSE),
        ...
        break;
case this.species.speciesId === SpeciesId.LYCANROC:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.SCARY_FACE),
        ...
        break;
case this.species.speciesId === SpeciesId.MACHAMP:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SEISMIC_TOSS),
              new PokemonMove(MoveId.DYNAMIC_PUNCH),
              new PokemonMove(MoveId.CROSS_CHOP),
              new PokemonMove(MoveId.DOUBLE_EDGE),
            ]
          : [
              new PokemonMove(MoveId.SEISMIC_TOSS),
        ...
        break;
case this.species.speciesId === SpeciesId.MAGEARNA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FLASH_CANNON),
              new PokemonMove(MoveId.PAIN_SPLIT),
              new PokemonMove(MoveId.ZAP_CANNON),
              new PokemonMove(MoveId.FLEUR_CANNON),
            ]
          : [
              new PokemonMove(MoveId.FLASH_CANNON),
              new PokemonMove(MoveId.PAIN_SPLIT),
        ...
        break;
case this.species.speciesId === SpeciesId.MANECTRIC:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CHARGE),
              new PokemonMove(MoveId.WILD_CHARGE),
              new PokemonMove(MoveId.THUNDER),
              new PokemonMove(MoveId.ELECTRIC_TERRAIN),
            ]
          : [
              new PokemonMove(MoveId.CHARGE),
              new PokemonMove(MoveId.WILD_CHARGE),
        ...
        break;
case this.species.speciesId === SpeciesId.MARSHADOW:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SPECTRAL_THIEF),
              new PokemonMove(MoveId.LASER_FOCUS),
              new PokemonMove(MoveId.ENDEAVOR),
              new PokemonMove(MoveId.CLOSE_COMBAT),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.MAUSHOLD:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CHARM),
              new PokemonMove(MoveId.BEAT_UP),
              new PokemonMove(MoveId.COPYCAT),
              new PokemonMove(MoveId.POPULATION_BOMB),
            ]
          : [
              new PokemonMove(MoveId.CHARM),
              new PokemonMove(MoveId.BEAT_UP),
        ...
        break;
case this.species.speciesId === SpeciesId.MAWILE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.IRON_HEAD),
              new PokemonMove(MoveId.TAUNT),
              new PokemonMove(MoveId.FAKE_TEARS),
              new PokemonMove(MoveId.PLAY_ROUGH),
            ]
          : [
              new PokemonMove(MoveId.IRON_HEAD),
        ...
        break;
case this.species.speciesId === SpeciesId.MEDICHAM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.POWER_TRICK),
              new PokemonMove(MoveId.RECOVER),
              new PokemonMove(MoveId.COUNTER),
              new PokemonMove(MoveId.AXE_KICK),
            ]
          : [
              new PokemonMove(MoveId.POWER_TRICK),
              new PokemonMove(MoveId.RECOVER),
        ...
        break;
case this.species.speciesId === SpeciesId.MELMETAL:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DYNAMIC_PUNCH),
              new PokemonMove(MoveId.SUPERPOWER),
              new PokemonMove(MoveId.DOUBLE_IRON_BASH),
              new PokemonMove(MoveId.HYPER_BEAM),
            ]
          : [
              new PokemonMove(MoveId.DYNAMIC_PUNCH),
        ...
        break;
case this.species.speciesId === SpeciesId.MELOETTA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HYPER_VOICE),
              new PokemonMove(MoveId.ROLE_PLAY),
              new PokemonMove(MoveId.CLOSE_COMBAT),
              new PokemonMove(MoveId.PERISH_SONG),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.MEOWSTIC:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.EXTRASENSORY),
              new PokemonMove(MoveId.SHADOW_BALL),
        ...
        break;
case this.species.speciesId === SpeciesId.MEOWTH:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
        ...
        break;
case this.species.speciesId === SpeciesId.METAGROSS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.AGILITY),
              new PokemonMove(MoveId.HYPER_BEAM),
              new PokemonMove(MoveId.EXPLOSION),
              new PokemonMove(MoveId.HONE_CLAWS),
            ]
          : [
              new PokemonMove(MoveId.AGILITY),
              new PokemonMove(MoveId.HYPER_BEAM),
        ...
        break;
case this.species.speciesId === SpeciesId.MEWTWO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.MIST),
              new PokemonMove(MoveId.PSYSTRIKE),
              new PokemonMove(MoveId.RECOVER),
              new PokemonMove(MoveId.FUTURE_SIGHT),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.MIMIKYU:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SHADOW_CLAW),
              new PokemonMove(MoveId.CHARM),
              new PokemonMove(MoveId.PLAY_ROUGH),
              new PokemonMove(MoveId.PAIN_SPLIT),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.MINIOR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.POWER_GEM),
              new PokemonMove(MoveId.DOUBLE_EDGE),
        ...
        break;
case this.species.speciesId === SpeciesId.MORPEKO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.BULLET_SEED),
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.AURA_WHEEL),
              new PokemonMove(MoveId.THRASH),
            ]
          : [
              new PokemonMove(MoveId.BULLET_SEED),
...
case this.species.speciesId === SpeciesId.NECROZMA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              ...
              new PokemonMove(MoveId.AUTOTOMIZE),
              new PokemonMove(MoveId.PRISMATIC_LASER),
            ]
          : [
              new PokemonMove(MoveId.POWER_GEM),
              new PokemonMove(MoveId.PHOTON_GEYSER),
        ...
        break;
case this.species.speciesId === SpeciesId.OGERPON:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DOUBLE_KICK),
              new PokemonMove(MoveId.COUNTER),
              new PokemonMove(MoveId.RETALIATE),
              new PokemonMove(MoveId.HORN_LEECH),
            ]
          : [
              new PokemonMove(MoveId.DOUBLE_KICK),
              new PokemonMove(MoveId.COUNTER),
        ...
        break;
case this.species.speciesId === SpeciesId.OINKOLOGNE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.UPROAR),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.EARTH_POWER),
              new PokemonMove(MoveId.BELCH),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.ORBEETLE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.AFTER_YOU),
              new PokemonMove(MoveId.CALM_MIND),
              new PokemonMove(MoveId.PSYCHIC_TERRAIN),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.ORICORIO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.AIR_SLASH),
              new PokemonMove(MoveId.REVELATION_DANCE),
              new PokemonMove(MoveId.AGILITY),
              new PokemonMove(MoveId.HURRICANE),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.PALAFIN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.MIST),
              new PokemonMove(MoveId.HYDRO_PUMP),
              new PokemonMove(MoveId.FOCUS_PUNCH),
              new PokemonMove(MoveId.WAVE_CRASH),
            ]
          : [
              new PokemonMove(MoveId.MIST),
        ...
        break;
case this.species.speciesId === SpeciesId.PALDEA_TAUROS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SWAGGER),
              new PokemonMove(MoveId.THRASH),
        ...
        break;
case this.species.speciesId === SpeciesId.PALKIA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.AQUA_TAIL),
              new PokemonMove(MoveId.EARTH_POWER),
              new PokemonMove(MoveId.SPACIAL_REND),
              new PokemonMove(MoveId.HYDRO_PUMP),
            ]
          : [
              new PokemonMove(MoveId.AQUA_TAIL),
        ...
        break;
case this.species.speciesId === SpeciesId.PICHU:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SWEET_KISS),
              new PokemonMove(MoveId.NUZZLE),
              new PokemonMove(MoveId.NASTY_PLOT),
              new PokemonMove(MoveId.CHARM),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.PIDGEOT:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ROOST),
              new PokemonMove(MoveId.TAILWIND),
              new PokemonMove(MoveId.AERIAL_ACE),
              new PokemonMove(MoveId.AIR_SLASH),
            ]
          : [
              new PokemonMove(MoveId.ROOST),
        ...
        break;
case this.species.speciesId === SpeciesId.PIKACHU:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.LIGHT_SCREEN),
              new PokemonMove(MoveId.SPLISHY_SPLASH),
              new PokemonMove(MoveId.THUNDER),
              new PokemonMove(MoveId.PIKA_PAPOW),
            ]
          : [
              new PokemonMove(MoveId.THUNDERBOLT),
              new PokemonMove(MoveId.LIGHT_SCREEN),
        ...
        break;
case this.species.speciesId === SpeciesId.PINSIR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SWORDS_DANCE),
              new PokemonMove(MoveId.SUBMISSION),
              new PokemonMove(MoveId.GUILLOTINE),
              new PokemonMove(MoveId.SUPERPOWER),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.POLTCHAGEIST:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.GIGA_DRAIN),
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.MEMENTO),
              new PokemonMove(MoveId.LEAF_STORM),
            ]
          : [
              new PokemonMove(MoveId.GIGA_DRAIN),
              new PokemonMove(MoveId.SHADOW_BALL),
        ...
        break;
case this.species.speciesId === SpeciesId.POLTEAGEIST:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.MEMENTO),
              new PokemonMove(MoveId.SHELL_SMASH),
              new PokemonMove(MoveId.CURSE),
            ]
          : [
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.MEMENTO),
        ...
        break;
case this.species.speciesId === SpeciesId.RAYQUAZA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FLY),
              new PokemonMove(MoveId.HURRICANE),
        ...
        break;
case this.species.speciesId === SpeciesId.REVAVROOM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.POISON_JAB),
              new PokemonMove(MoveId.UPROAR),
        ...
        break;
case this.species.speciesId === SpeciesId.RILLABOOM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.UPROAR),
              new PokemonMove(MoveId.WOOD_HAMMER),
        ...
        break;
case this.species.speciesId === SpeciesId.ROCKRUFF:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.SCARY_FACE),
        ...
        break;
case this.species.speciesId === SpeciesId.ROTOM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SUBSTITUTE),
              new PokemonMove(MoveId.TRICK),
              new PokemonMove(MoveId.DISCHARGE),
              new PokemonMove(MoveId.UPROAR),
            ]
          : [
              new PokemonMove(MoveId.SUBSTITUTE),
        ...
        break;
case this.species.speciesId === SpeciesId.SABLEYE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.POWER_GEM),
              new PokemonMove(MoveId.ZEN_HEADBUTT),
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.FOUL_PLAY),
            ]
          : [
        ...
        break;
case this.species.speciesId === SpeciesId.SALAMENCE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FOCUS_ENERGY),
              new PokemonMove(MoveId.FLAMETHROWER),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.OUTRAGE),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.SANDACONDA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SANDSTORM),
              new PokemonMove(MoveId.SLAM),
              new PokemonMove(MoveId.COIL),
              new PokemonMove(MoveId.SAND_TOMB),
            ]
          : [
              new PokemonMove(MoveId.SANDSTORM),
              new PokemonMove(MoveId.SLAM),
        ...
        break;
case this.species.speciesId === SpeciesId.SAWSBUCK:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ENERGY_BALL),
              new PokemonMove(MoveId.CHARM),
        ...
        break;
case this.species.speciesId === SpeciesId.SCEPTILE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.FURY_CUTTER),
              new PokemonMove(MoveId.X_SCISSOR),
              new PokemonMove(MoveId.ENERGY_BALL),
              new PokemonMove(MoveId.SHED_TAIL),
            ]
          : [
              new PokemonMove(MoveId.FURY_CUTTER),
              new PokemonMove(MoveId.X_SCISSOR),
        ...
        break;
case this.species.speciesId === SpeciesId.SCIZOR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.IRON_DEFENSE),
              new PokemonMove(MoveId.IRON_HEAD),
        ...
        break;
case this.species.speciesId === SpeciesId.SHARPEDO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.AGILITY),
        ...
        break;
case this.species.speciesId === SpeciesId.SHAYMIN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ENERGY_BALL),
              new PokemonMove(MoveId.SWEET_KISS),
              new PokemonMove(MoveId.LEAF_STORM),
              new PokemonMove(MoveId.SEED_FLARE),
            ]
          : [
              new PokemonMove(MoveId.ENERGY_BALL),
              new PokemonMove(MoveId.SWEET_KISS),
        ...
        break;
case this.species.speciesId === SpeciesId.SILVALLY:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.TAKE_DOWN),
        ...
        break;
case this.species.speciesId === SpeciesId.SINISTCHA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SHADOW_BALL),
              new PokemonMove(MoveId.MEMENTO),
        ...
        break;
case this.species.speciesId === SpeciesId.SINISTEA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.NASTY_PLOT),
              new PokemonMove(MoveId.SHADOW_BALL),
        ...
        break;
case this.species.speciesId === SpeciesId.SLOWBRO:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.PSYCH_UP),
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.HEAL_PULSE),
              new PokemonMove(MoveId.FUTURE_SIGHT),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.SNORLAX:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HAMMER_ARM),
              new PokemonMove(MoveId.BELLY_DRUM),
        ...
        break;
case this.species.speciesId === SpeciesId.SQUAWKABILLY:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SWAGGER),
              new PokemonMove(MoveId.BRAVE_BIRD),
        ...
        break;
case this.species.speciesId === SpeciesId.STARMIE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.RAPID_SPIN),
              new PokemonMove(MoveId.COSMIC_POWER),
              new PokemonMove(MoveId.BRINE),
              new PokemonMove(MoveId.POWER_GEM),
            ]
          : [
              new PokemonMove(MoveId.RAPID_SPIN),
        ...
        break;
case this.species.speciesId === SpeciesId.STEELIX:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.IRON_TAIL),
              new PokemonMove(MoveId.STONE_EDGE),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.MAGNET_RISE),
            ]
          : [
              new PokemonMove(MoveId.IRON_TAIL),
              new PokemonMove(MoveId.STONE_EDGE),
        ...
        break;
case this.species.speciesId === SpeciesId.SWAMPERT:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SURF),
              new PokemonMove(MoveId.EARTHQUAKE),
              new PokemonMove(MoveId.ROCK_SMASH),
              new PokemonMove(MoveId.HAMMER_ARM),
            ]
          : [
              new PokemonMove(MoveId.SURF),
        ...
        break;
case this.species.speciesId === SpeciesId.TATSUGIRI:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.MUDDY_WATER),
              new PokemonMove(MoveId.NASTY_PLOT),
              new PokemonMove(MoveId.MIRROR_COAT),
              new PokemonMove(MoveId.DRAGON_PULSE),
            ]
          : [
              new PokemonMove(MoveId.MUDDY_WATER),
        ...
        break;
case this.species.speciesId === SpeciesId.TERAPAGOS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.TERA_STARSTORM),
              new PokemonMove(MoveId.DOUBLE_EDGE),
              new PokemonMove(MoveId.ROCK_POLISH),
              new PokemonMove(MoveId.GYRO_BALL),
            ]
          : [
              new PokemonMove(MoveId.TERA_STARSTORM),
              new PokemonMove(MoveId.DOUBLE_EDGE),
        ...
        break;
case this.species.speciesId === SpeciesId.THUNDURUS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.THUNDER),
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.WILDBOLT_STORM),
            ]
          : [
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.THUNDER),
        ...
        break;
case this.species.speciesId === SpeciesId.TORNADUS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.HURRICANE),
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.BLEAKWIND_STORM),
            ]
          : [
              new PokemonMove(MoveId.RAIN_DANCE),
              new PokemonMove(MoveId.HURRICANE),
        ...
        break;
case this.species.speciesId === SpeciesId.TOXTRICITY:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.POISON_JAB),
              new PokemonMove(MoveId.OVERDRIVE),
              new PokemonMove(MoveId.BOOMBURST),
              new PokemonMove(MoveId.MAGNETIC_FLUX),
            ]
          : [
              new PokemonMove(MoveId.POISON_JAB),
              new PokemonMove(MoveId.OVERDRIVE),
        ...
        break;
case this.species.speciesId === SpeciesId.TYRANITAR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.SANDSTORM),
...
case this.species.speciesId === SpeciesId.UNOWN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HIDDEN_POWER),
            ]
          : [
              new PokemonMove(MoveId.HIDDEN_POWER),
            ];
        ...
        break;
case this.species.speciesId === SpeciesId.URSHIFU:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.DYNAMIC_PUNCH),
              new PokemonMove(MoveId.COUNTER),
        ...
        break;
case this.species.speciesId === SpeciesId.VENUSAUR:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SYNTHESIS),
              new PokemonMove(MoveId.WORRY_SEED),
              new PokemonMove(MoveId.POWER_WHIP),
              new PokemonMove(MoveId.SOLAR_BEAM),
            ]
          : [
              new PokemonMove(MoveId.SYNTHESIS),
        ...
        break;
case this.species.speciesId === SpeciesId.VIVILLON:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SAFEGUARD),
              new PokemonMove(MoveId.BUG_BUZZ),
              new PokemonMove(MoveId.QUIVER_DANCE),
              new PokemonMove(MoveId.HURRICANE),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.WISHIWASHI:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.AQUA_RING),
              new PokemonMove(MoveId.ENDEAVOR),
        ...
        break;
case this.species.speciesId === SpeciesId.WORMADAM:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.ATTRACT),
              new PokemonMove(MoveId.PSYCHIC),
              new PokemonMove(MoveId.FISSURE),
              new PokemonMove(MoveId.BUG_BUZZ),
            ]
        ...
        break;
case this.species.speciesId === SpeciesId.XERNEAS:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.MEGAHORN),
              new PokemonMove(MoveId.CLOSE_COMBAT),
        ...
        break;
case this.species.speciesId === SpeciesId.ZACIAN:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.MOONBLAST),
        ...
        break;
case this.species.speciesId === SpeciesId.ZAMAZENTA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.CRUNCH),
              new PokemonMove(MoveId.MOONBLAST),
        ...
        break;
case this.species.speciesId === SpeciesId.ZERAORA:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.PLASMA_FISTS),
              new PokemonMove(MoveId.COLLISION_COURSE),
              new PokemonMove(MoveId.ICE_PUNCH),
        ...
        break;
case this.species.speciesId === SpeciesId.ZARUDE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.HAMMER_ARM),
              new PokemonMove(MoveId.THRASH),
              new PokemonMove(MoveId.POWER_WHIP),
              new PokemonMove(MoveId.JUNGLE_HEALING),
            ]
          : [
              new PokemonMove(MoveId.HAMMER_ARM),
              new PokemonMove(MoveId.THRASH),
        ...
        break;
case this.species.speciesId === SpeciesId.ZYGARDE:
        this.moveset = (formIndex !== undefined ? formIndex : this.formIndex)
          ? [
              new PokemonMove(MoveId.SANDSTORM),
              new PokemonMove(MoveId.COIL),
